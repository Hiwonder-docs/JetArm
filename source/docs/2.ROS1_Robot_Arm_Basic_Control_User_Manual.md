...
(1) Open a new terminal <img src="../_static/media/chapter_2/section_1/media/image6.png"  />, and execute the command below and hit **'Tab'** key to auto-complement the command.
...
(1) Run the command below in the terminal <img src="../_static/media/chapter_2/section_1/media/image6.png"  /> to initiate the robotic arm SDK file.
...
(1) Double-click <img src="../_static/media/chapter_2/section_1/media/image6.png"  /> to initiate the command terminal and run the following command to disable the auto-start service.
...
Launch file is saved in [/home/hiwonder/jetarm/src/jetarm_example/src/LED/LED.launch](../_static/source_code/02/LED.zip)
...
| Icon                                                         | Function                                    |
| ------------------------------------------------------------ | ------------------------------------------- |
| <img  src="../_static/media/chapter_2/section_1/media/image2.png"  /> | End-effector coordinates of the robotic arm |
| <img  src="../_static/media/chapter_2/section_1/media/image3.png"  /> | Pitch angle control of the end effector     |
| <img  src="../_static/media/chapter_2/section_1/media/image4.png"  /> | Execute action                              |
...
(2) Open the terminal <img src="../_static/media/chapter_2/section_1/media/image6.png"  />to enter the following command to access the file.
