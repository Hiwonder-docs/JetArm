...
(1) Assemble the robot arm according to the tutorial stored in '[1. Getting Ready(JetArm User Manual) -> 1.2 Hardware Installation and Guidelines](1.Getting_Ready.md#hardware-installation-and-guidelines)'.

(2) Start the robot arm according to the tutorial saved in '[1. Getting Ready(JetArm User Manual) ->1.3 Initial Startup Instructions](1.Getting_Ready.md#initial-startup-instructions).

(3) Access the robot arm system desktop according to the tutorials locating in '[1. Getting Ready(JetArm User Manual)->1.6 Development Environment Setup and Configuration](1.Getting_Ready.md#development-environment-setup-and-configuration)'.
...
(1) Open a new terminal <img src="../_static/media/chapter_2/image6.png"  />, and execute the command below and hit **'Tab'** key to auto-complement the command.
...
(1) Run the command below in the terminal <img src="../_static/media/chapter_2/image6.png"  /> to initiate the robotic arm SDK file.
...
(1) Double-click <img src="../_static/media/chapter_2/image6.png"  /> to initiate the command terminal and run the following command to disable the auto-start service.
...
The launch file locates in this folder, [/home/ubuntu/jetarm/src/jetarm_example/src/bus_servo/bus_servo.launch](../_static/source_code/bus_servo.zip)
...
The source code of the program is saved in [/home/ubuntu/jetarm/src/jetarm_example/src/bus_servo/bus_servo.py](../_static/source_code/bus_servo.zip).
...
(2) Execute the following command to start servo control. The LED.py file is invoked in the launch file.
...
Launch file is saved in [/home/hiwonder/jetarm/src/jetarm_example/src/LED/LED.launch](../_static/source_code/LED.zip)
...
The source code is stored in [jetarm/src/jetarm_example/src/LED/LED.py](../_static/source_code/LED.zip)
...
The launch file is saved in [/home/ubuntu/jetarm/src/jetarm_example/src/buzzer/buzzer.launch](../_static/source_code/buzzer.zip)
...
The source code is saved in [jetarm/src/jetarm_example/src/buzzer/buzzer.py](../_static/source_code/buzzer.zip).
...
<img class="common_img" src="../_static/media/chapter_2/image1.png"  />

| Icon                                                         | Function                                    |
| ------------------------------------------------------------ | ------------------------------------------- |
| <img  src="../_static/media/chapter_2/image2.png"  /> | End-effector coordinates of the robotic arm |
| <img  src="../_static/media/chapter_2/image3.png"  /> | Pitch angle control of the end effector     |
| <img  src="../_static/media/chapter_2/image4.png"  /> | Execute action                              |
...
For ease of later debugging and management, you can save the action file. Click-on the '**Save Action File**' button and select this folder '**/home/hiwonder/arm_pc/ActionGrourps**,'. After naming the action file, click-on '**Save**' button.
...
<img class="common_img" src="../_static/media/chapter_2/image122.png" style="width:600px;" />
...
The servo is now centered, so please refrain from forcibly manipulating the servo shaft. If the servo horn 'cross' is not correctly installed, repeat steps 5-7 in [Large Deviation Adjustment](#large_deviation_adjustment) of this document.
...
When replacing a servo, it is essential to utilize the servo debugging tool for configuring parameters such as ID and midpoint. Refer to the earlier **2.5.1 Introduction to Servo Debbugging Tool Interface** for information on servo ID numbers.
...
(2) Open the terminal <img src="../_static/media/chapter_2/image6.png"  />to enter the following command to access the file.
...
(3) Then enter the command to launch the host control software. After it opens, make sure that only one servo is connected to the bus interface—do not daisy-chain it with other servos.
