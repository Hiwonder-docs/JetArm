# 21. ROS2-AI Large Model Courses

## 21.1 Large Models Basic Courses

### 21.1.1 Large Language Model Courses
...
<img class="common_img" src="../_static/media/chapter_21/section_1.1/01/image2.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.1/02/image2.png"  />

② Follow the prompts to register and log in using your Google, Microsoft, or Apple account.

<img class="common_img" src="../_static/media/chapter_21/section_1.1/02/image3.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.1/02/image4.png"  />

<img class="common_img" src="../_static/media/chapter_21/section_1.1/02/image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.1/02/image6.png"  />

<img class="common_img" src="../_static/media/chapter_21/section_1.1/02/image7.png"  />

<img class="common_img" src="../_static/media/chapter_21/section_1.1/02/image8.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.1/02/image9.png"  />

<img class="common_img" src="../_static/media/chapter_21/section_1.1/02/image10.png"  />

② After logging in, click the icon in the top-right corner and select **"Credits"** to link your payment method.

<img class="common_img" src="../_static/media/chapter_21/section_1.1/02/image11.png"  />

<img class="common_img" src="../_static/media/chapter_21/section_1.1/02/image12.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.1/02/image13.png"  />

<img class="common_img" src="../_static/media/chapter_21/section_1.1/02/image14.png"  />

④ At this point, the large model is successfully created and deployed. You can now use the API in the upcoming lessons.

<p id="anchor_21_1_1_3"></p>

* **Large Language Model Accessing**

:::{Note}

To proceed with this section, you will need to register on the appropriate website and obtain the API key for the large model (please refer to the file ["**21.1.1 Large Language Model Courses -> Large Language Model Deployment**"](#anchor_21_1_1_2)).
...
<img class="common_img" src="../_static/media/chapter_21/section_1.1/03/image2.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.1/03/image3.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.1/03/image4.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.1/03/image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.1/03/image13.png"  />
...
③ Once the file is open, configure the OpenAI and OpenRouter keys by filling in the llm_api_key and vllm_api_key parameters, respectively (you can obtain these keys from the '[21.1.1 Large Language Model Courses -> Large Language Model Deployment](#anchor_21_1_1_2)' course).

<img class="common_img" src="../_static/media/chapter_21/section_1.1/03/image21.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.1/03/image22.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.1/03/image24.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.1/03/image26.png"  />

* **Semantic Understanding with Large Language Model**

Before starting this section, make sure you have completed the API key configuration outlined in the file [21.1.1 Large Language Model Courses -\> Large Language Model Accessing](#anchor_21_1_1_3).
...
<img class="common_img" src="../_static/media/chapter_21/section_1.1/01/image4.png" style="width:100%;" />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.1/01/image5.png" style="width:100%;"/>

* **Emotional Perception with Large Language Model**

To proceed with this section, ensure that you have completed the API key configuration as described in the file [21.1.1 Language Model Courses -> Large Language Model Accessing](#anchor_21_1_1_3).
...
<img class="common_img" src="../_static/media/chapter_21/section_1.1/01/image6.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.1/01/image7.png"  />

### 21.1.2 Large Speech Model Courses
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/02/image2.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/02/image3.png"   />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/02/image4.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/02/image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/02/image6.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/02/image8.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/03/image3.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/03/image4.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/03/image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/03/image7.png"  />

④ Press ESC to return to command mode, then type :wq and press Enter to save and exit.

<img class="common_img" src="../_static/media/chapter_21/section_1.2/03/image8.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/03/image10.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/03/image17.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/03/image19.png"  />
...
Before proceeding, refer to the course "[**21.1.2 Large Speech Model Courses -> Large Language Models Deployment**](#anchor_21_1_1_2)" to obtain your API key, and make sure to add it into the configuration file (config).
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/04/image3.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/04/image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/04/image10.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/04/image12.png"  />
...
Refer to the course "[**21.1.1Large Language Models Courses -> Large Language Models Deployment**](#anchor_21_1_1_2)" to obtain your API key, and update the configuration file accordingly.
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/05/image3.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/05/image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/05/image9.png"  />

<img class="common_img" src="../_static/media/chapter_21/section_1.2/05/image10.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/05/image11.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/05/image12.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/06/image2.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/06/image4.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/06/image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.2/06/image7.png"  />
...
### 21.1.3 Vision Language Model Courses
...
* This section requires the configuration of the API key in "[**21.1.3 Vision Language Model Accessing -> Vision Language Model Accessing**](#anchor_21_1_1_3)" before proceeding. Additionally, ensure that the images to be used in this section are imported.
...
<img class="common_img" src="../_static/media/chapter_21/section_1.3/02/image4.png"  />

<img class="common_img" src="../_static/media/chapter_21/section_1.3/02/image5.jpeg"   />

* **Vision Language Model: Object Detection**

:::{Note}

* This section requires the configuration of the API key in "[**21.1.3 Vision Language Module Courses -> Vision Language Model Accessing**](#anchor_21_1_1_3)" before proceeding. Additionally, ensure that the images to be used in this section are imported.
...
<img class="common_img" src="../_static/media/chapter_21/section_1.3/03/image4.png"  />

<img class="common_img" src="../_static/media/chapter_21/section_1.3/03/image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.3/03/image6.png"  />

<img class="common_img" src="../_static/media/chapter_21/section_1.3/03/image7.png"  />

<img class="common_img" src="../_static/media/chapter_21/section_1.3/03/image8.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.3/03/image10.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.3/03/image11.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.3/03/image12.png"  />

* **Vision Language Model: Scene Understanding**

:::{Note}

* This section requires the configuration of the API key in "[**Vision Language Model Accessing**](#anchor_21_1_1_3)" before proceeding. Additionally, ensure that the images to be used in this section are imported.
...
<img class="common_img" src="../_static/media/chapter_21/section_1.3/04/image4.png"  />

<img class="common_img" src="../_static/media/chapter_21/section_1.3/04/image5.jpeg"   />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.3/04/image6.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.3/04/image8.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.3/04/image10.png"  />

<img class="common_img" src="../_static/media/chapter_21/section_1.3/04/image11.png"   />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.3/05/image4.png"  />

<img class="common_img" src="../_static/media/chapter_21/section_1.3/05/image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.3/05/image6.png"  />

<img class="common_img" src="../_static/media/chapter_21/section_1.3/05/image7.png"   />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.3/05/image9.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.3/05/image12.png"  />

### 21.1.4 Multimodal Model Basic Courses
...
<img class="common_img" src="../_static/media/chapter_21/section_1.4/image2.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.4/image4.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.4/image5.png"  />

For 6-channel Microphone, update the respective settings:

<img class="common_img" src="../_static/media/chapter_21/section_1.4/image6.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.4/image8.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_1.4/image9.png"  />



## 21.2 Multimodal Model Courses

### 21.2.1 Multimodal Model: Voice Control
...
① After remotely logging into the machine using NoMachine, click on the desktop icon <img   src="../_static/media/chapter_21/section_2/01/image2.png"  />.
...
<img class="common_img" src="../_static/media/chapter_21/section_2/01/image3.png" style="width:500px;" />

For the "Six-**Microphone Array**", choose "**xf**" as the microphone type.

<img class="common_img" src="../_static/media/chapter_21/section_2/01/image4.png" style="width:500px;"/>

<img class="common_img" src="../_static/media/chapter_21/section_2/01/image5.png" style="width:500px;"/>

③ Then click "Apply & Save".

<img class="common_img" src="../_static/media/chapter_21/section_2/01/image6.png" style="width:500px;"/>
...
<img class="common_img" src="../_static/media/chapter_21/section_2/01/image12.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_2/01/image13.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_2/01/image14.png"  />
...
The program is saved at: [/home/ubuntu/ros2_ws/src/large_models_examples/large_models_examples/llm_control_servo.launch.py](../_static/source_code/large_models_examples.zip)
...
The program is saved at : [/home/ubuntu/ros2_ws/src/large_models_examples/large_models_examples/llm_control_servo.py](../_static/source_code/large_models_examples.zip)
...
### 21.2.2 Multimodal Model: Color Sorting
...
① After remotely logging into the machine using NoMachine, click on the desktop icon <img class="common_img" src="../_static/media/chapter_21/section_2/02/image2.png"  />.

② Select the appropriate microphone version configuration based on the hardware you are using. For example, choose the robot type as **"JetArm Advance",** camera type as **"Gemini,"** and ASR language as **"English"**.

<img class="common_img" src="../_static/media/chapter_21/section_2/02/image3.png" style="width:500px;"/>

For the **"Six-Microphone Array"**, choose **"xf"** as the microphone type.

<img class="common_img" src="../_static/media/chapter_21/section_2/02/image4.png" style="width:500px;" />

<img class="common_img" src="../_static/media/chapter_21/section_2/02/image5.png" style="width:500px;"/>

① Then click **"Apply & Save".**

<img class="common_img" src="../_static/media/chapter_21/section_2/02/image6.png" style="width:500px;" />
...
[vim /home/ubuntu/ros2_ws/src/large_models/large_models/large_models/config.py](../_static/source_code/large_models_examples.zip)

Refer to the "[**21.1.1 Large Language Model Courses\->  Large Language Model Deployment**](#anchor_21_1_1_2)" to obtain the API-KEY for the large model. After acquiring the visual large model API-KEY (from the Openrouter website), fill it into the vllm_api_key parameter. Similarly, obtain the API-KEY for the large language model (from the OpenAI website) and fill it into the llm_api_key parameter, as indicated by the red box in the image below.

<img class="common_img" src="../_static/media/chapter_21/section_2/02/image9.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_2/02/image12.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_2/02/image13.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_2/02/image14.png"  />
...
The program is saved at:[/home/ubuntu/ros2_ws/src/large_models_examples/large_models_examples/llm_object_sorting.launch.py](../_static/source_code/large_models_examples.zip)
...
[/home/ubuntu/ros2_ws/src/large_models_examples/large_models_examples/llm_object_sorting.py](../_static/source_code/large_models_examples.zip)
...
### 21.2.3 Multimodal Model: Waste Classification
...
① After remotely logging into the machine using NoMachine, click on the desktop icon <img src="../_static/media/chapter_21/section_2/03/image2.png"  />.

② Select the appropriate microphone version configuration based on the hardware you are using. For example, choose the robot type as **"JetArm Advance,"** camera type as **"Gemini,"** and ASR language as **"English".**

<img class="common_img" src="../_static/media/chapter_21/section_2/03/image3.png" style="width:500px;"/>

For the **"Six-Microphone Array",** choose **"xf"** as the microphone type.

<img class="common_img" src="../_static/media/chapter_21/section_2/03/image4.png" style="width:500px;"/>

<img class="common_img" src="../_static/media/chapter_21/section_2/03/image5.png" style="width:500px;"/>

① Then click **"Apply & Save".**

<img class="common_img" src="../_static/media/chapter_21/section_2/03/image6.png" style="width:500px;"/>
...
<img class="common_img" src="../_static/media/chapter_21/section_2/03/image9.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_2/03/image12.png"  />

(6) When the command line shows the output below, it indicates that the cloud-based voice large model's speech recognition service has successfully processed the user's command audio. The recognition result will be displayed under **"publish_asr_result".**

<img class="common_img" src="../_static/media/chapter_21/section_2/03/image13.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_2/03/image14.png"  />
...
The program is saved at: [ros2_ws/src/large_models_examples/large_models_examples/llm_waste_classification.launch.py](../_static/source_code/large_models_examples.zip)
...
The program is saved at: [ros2_ws/src/jetarm_large_models_examples/large_models_examples/llm_waste_classification.py](../_static/source_code/large_models_examples.zip)
...
### 21.2.4 Multimodal Model: Object Sorting
...
① After remotely logging into the machine using NoMachine, click on the desktop icon <img class="common_img" src="../_static/media/chapter_21/section_2/04/image2.png"  />.

② Select the appropriate microphone version configuration based on the hardware you are using. For example, choose the robot type as "**JetArm Advance**", camera type as "Gemini****", and ASR language as "**English**".

<img class="common_img" src="../_static/media/chapter_21/section_2/04/image3.png" style="width:500px;"/>

For the **"Six-Microphone Array,"** choose **"xf"** as the microphone type.

<img class="common_img" src="../_static/media/chapter_21/section_2/04/image4.png" style="width:500px;"/>

<img class="common_img" src="../_static/media/chapter_21/section_2/04/image5.png" style="width:500px;"/>

① Then click **"Apply & Save".**

<img class="common_img" src="../_static/media/chapter_21/section_2/04/image6.png" style="width:500px;"/>
...
<img class="common_img" src="../_static/media/chapter_21/section_2/04/image9.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_2/04/image12.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_2/04/image13.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_2/04/image14.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_2/04/image15.png"  />
...
The program is saved at:[/home/ubuntu/ros2_ws/src/large_models_examples/large_models_examples/llm_3d_object_sorting.launch.py](../_static/source_code/large_models_examples.zip)
...
The program is saved at:[/home/ubuntu/ros2_ws/src/large_models_examples/large_models_examples/llm_3d_object_sorting.py](../_static/source_code/large_models_examples.zip)
...
## 21.3 Embodied AI Applications

### 21.3.1 Overview of Multimodal Information Fusion
...
<img class="common_img" src="../_static/media/chapter_21/section_3/01/image2.jpeg"   />
...
<img class="common_img" src="../_static/media/chapter_21/section_3/01/image3.jpeg"   />
...
<img class="common_img" src="../_static/media/chapter_21/section_3/01/image4.jpeg"   />
...
<img class="common_img" src="../_static/media/chapter_21/section_3/01/image5.jpeg"   />
...
<img class="common_img" src="../_static/media/chapter_21/section_3/01/image6.jpeg"   />
...
<img class="common_img" src="../_static/media/chapter_21/section_3/01/image7.jpeg"   />
...
### 21.3.2 Embodied AI Applications in Real-Time Detection
...
① After remotely logging into the machine using NoMachine, click on the desktop icon <img class="common_img" src="../_static/media/chapter_21/section_3/02/image2.png"  />.
...
<img class="common_img" src="../_static/media/chapter_21/section_3/02/image3.jpeg" style="width:500px;" />

For the **"Six-Microphone Array,"** choose "xf" as the microphone type.

<img class="common_img" src="../_static/media/chapter_21/section_3/02/image4.png" style="width:500px;"  />

<img class="common_img" src="../_static/media/chapter_21/section_3/02/image5.png" style="width:500px;"/>

① Then click **"Apply & Save".**

<img class="common_img" src="../_static/media/chapter_21/section_3/02/image6.png" style="width:500px;"/>
...
<img class="common_img" src="../_static/media/chapter_21/section_3/02/image9.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_3/02/image12.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_3/02/image13.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_3/02/image14.png"  />
...
[/home/ubuntu/ros2_ws/src/large_models_examples/large_models_examples/vllm_with_camera.launch.py](../_static/source_code/large_models_examples.zip)
...
[/home/ubuntu/ros2_ws/src/jetarm_large_models/large_models/large_models/vllm_with_camera.py](../_static/source_code/large_models_examples.zip)
...
### 21.3.3 Embodied AI Applications in Vision Tracking
...
① After remotely logging into the machine using NoMachine, click on the desktop icon <img src="../_static/media/chapter_21/section_3/03/image2.png"  />.

② Select the appropriate microphone version configuration based on your hardware. For example: choose the robot type: JetArm Advance, camera type: Gemini, and language: English.

<img class="common_img" src="../_static/media/chapter_21/section_3/03/image3.jpeg" style="width:500px;"/>

For the **"Six-Microphone Array,"** choose **"xf"** as the microphone type.

<img class="common_img" src="../_static/media/chapter_21/section_3/03/image4.png"  style="width:500px;"/>

<img class="common_img" src="../_static/media/chapter_21/section_3/03/image5.png" style="width:500px;"/>

① Then click **"Apply & Save".**

<img class="common_img" src="../_static/media/chapter_21/section_3/03/image6.png" style="width:500px;" />
...
<img class="common_img" src="../_static/media/chapter_21/section_3/03/image9.png"  />
...
(2) Enter the following command and press Enter to initiate voice-controlled game:

```
ros2 launch large_models_examples vllm_track.launch.py
```

(3) Once the command line outputs the message below and the device announces "**I am ready**", it indicates that the voice device has been initialized. You can now say the wake word, "**hello hi wonder**".

<img class="common_img" src="../_static/media/chapter_21/section_3/03/image12.png"  style="width:100%;"/>

(4) When the command line shows the output below, it indicates that the cloud-based voice large model's speech recognition service has successfully processed the user's command audio. The recognition result will be displayed under "**publish_asr_result**".

<img class="common_img" src="../_static/media/chapter_21/section_3/03/image13.png" style="width:100%;"/>

(5) When the command line shows the output below, it indicates that the cloud-based large language model has successfully processed the user's command, thought through the instruction, and provided a verbal response ("**response**"), as well as designed an action that aligns with the user's command meaning.

The response is automatically generated by the large model, ensuring the accuracy of the meaning, though the wording and structure of the reply may vary.

<img class="common_img" src="../_static/media/chapter_21/section_3/03/image14.png" style="width:100%;"/>

(6) When the command line shows the output below, it indicates that one round of interaction has been completed. You can refer to Step 4) to reactivate the voice device using the wake-up word and begin a new round of interaction.

<img class="common_img" src="../_static/media/chapter_21/section_3/03/image15.png" style="width:100%;"/>

(7) To exit this feature, simply press "**Ctrl+C**" in the terminal. If it doesn't close on the first attempt, you may need to press it multiple times.
...
<img class="common_img" src="../_static/media/chapter_21/section_3/03/image16.png"  />
...
[/home/ubuntu/ros2_ws/src/large_models_examples/large_models_examples/vllm_track.launch.py](../_static/source_code/large_models_examples.zip)
...
[/home/ubuntu/ros2_ws/src/jetarm_large_models/large_models/large_models/vllm_track.py](../_static/source_code/large_models_examples.zip)
...
### 21.3.4 Embodied AI Applications in Intelligent Transport
...
① After remotely logging into the machine using NoMachine, click on the desktop icon <img src="../_static/media/chapter_21/section_3/04/image2.png"  />.

② Select the appropriate microphone version configuration based on your hardware. For example: choose the robot type: JetArm Advance, camera type: Gemini, and language: English.

<img class="common_img" src="../_static/media/chapter_21/section_3/04/image3.jpeg"  style="width:500px;"/>

For the **"Six-Microphone Array,"** choose **"xf"** as the microphone type.

<img class="common_img" src="../_static/media/chapter_21/section_3/04/image4.png"  style="width:500px;" />

<img class="common_img" src="../_static/media/chapter_21/section_3/04/image5.png" style="width:500px;" />

① Then click **"Apply & Save".**

<img class="common_img" src="../_static/media/chapter_21/section_3/04/image6.png" style="width:500px;"/>
...
<img class="common_img" src="../_static/media/chapter_21/section_3/04/image9.png"  />
...
(3) When the command line shows the output as shown in the image and announces "**I am ready**", it means that the "**voice device**" has completed initialization, and the YOLOv8 model will also be initialized. At this point, you can say the wake-up phrase, "**hello hi wonder**".

<img class="common_img" src="../_static/media/chapter_21/section_3/04/image12.png"  />

(4) When the command line shows the output below and the device announces "**I am here**", it means the voice device has been successfully activated. At this point, the system will begin recording the user's command.
...
<img class="common_img" src="../_static/media/chapter_21/section_3/04/image13.png"  />

(5) When the command line shows the output below, it indicates that the cloud-based voice large model's speech recognition service has successfully processed the user's command audio. The recognition result will be displayed under "**publish_asr_result**".

<img class="common_img" src="../_static/media/chapter_21/section_3/04/image14.png" style="width:100%;"/>

(6) When the command line shows the output below, it indicates that the cloud-based large language model has successfully processed the user's command, thought through the instruction, and provided a verbal response ("**response**"), as well as designed an action that aligns with the user's command meaning.

The response is automatically generated by the large model, ensuring the accuracy of the meaning, though the wording and structure of the reply may vary.

<img class="common_img" src="../_static/media/chapter_21/section_3/04/image15.png"  />

(7) When the command line shows the output below, it indicates that one round of interaction has been completed. You can refer to Step 4) to reactivate the voice device using the wake-up word and begin a new round of interaction.

<img class="common_img" src="../_static/media/chapter_21/section_3/04/image16.png"  />

(8) To exit this feature, simply press "**Ctrl+C**" in the terminal. If it doesn't close on the first attempt, you may need to press it multiple times.
...
<img class="common_img" src="../_static/media/chapter_21/section_3/04/image17.png"   />

<img class="common_img" src="../_static/media/chapter_21/section_3/04/image18.png"   />

<img class="common_img" src="../_static/media/chapter_21/section_3/04/image19.png"   />

<img class="common_img" src="../_static/media/chapter_21/section_3/04/image20.png"   />

* **Brief Program Analysis**

(1) Analysis of launch File

The program is saved at: [/home/ubuntu/ros2_ws/src/large_models_examples/large_models_examples/vllm_object_transport.launch.py](../_static/source_code/large_models_examples.zip)
...
The program is saved at:[/home/ubuntu/ros2_ws/src/large_models_examples/large_models_examples/vllm_object_transport.py](../_static/source_code/large_models_examples.zip)
...
### 21.3.5 Embodied AI Applications in Smart Home Assistant
...
① After remotely logging into the machine using NoMachine, click on the desktop icon <img src="../_static/media/chapter_21/section_3/05/image2.png"  />.

② Select the appropriate microphone version configuration based on your hardware. For example: choose the robot type: JetArm Advance, camera type: Gemini, and language: English.

<img class="common_img" src="../_static/media/chapter_21/section_3/05/image3.jpeg"  style="width:500px;"/>

For the **"Six-Microphone Array,"** choose **"xf"** as the microphone type.

<img class="common_img" src="../_static/media/chapter_21/section_3/05/image4.png"  style="width:500px;"/>

<img class="common_img" src="../_static/media/chapter_21/section_3/05/image5.png"  style="width:500px;"/>

① Then click "Apply & Save".

<img class="common_img" src="../_static/media/chapter_21/section_3/05/image6.png" style="width:500px;"/>
...
<img class="common_img" src="../_static/media/chapter_21/section_3/05/image9.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_3/05/image12.png"  />

(4) When the command line shows the output below and the device announces "**I am here**", it means the voice device has been successfully activated. At this point, the system will begin recording the user's command.

<img class="common_img" src="../_static/media/chapter_21/section_3/05/image13.png"  />

(5) When the command line shows the output below, it indicates that the cloud-based voice large model's speech recognition service has successfully processed the user's command audio. The recognition result will be displayed under "**publish_asr_result**".

<img class="common_img" src="../_static/media/chapter_21/section_3/05/image14.png"  />

(6) When the command line shows the output below, it indicates that the cloud-based large language model has successfully processed the user's command, thought through the instruction, and provided a verbal response ("response"), as well as designed an action that aligns with the user's command meaning.

The response is automatically generated by the large model, ensuring the accuracy of the meaning, though the wording and structure of the reply may vary.

<img class="common_img" src="../_static/media/chapter_21/section_3/05/image15.png"  />

(7) When the command line shows the output below, it indicates that one round of interaction has been completed. You can refer to Step 4) to reactivate the voice device using the wake-up word and begin a new round of interaction.

<img class="common_img" src="../_static/media/chapter_21/section_3/05/image16.png"  />
...
<img class="common_img" src="../_static/media/chapter_21/section_3/05/image17.png"   />

<img class="common_img" src="../_static/media/chapter_21/section_3/05/image18.png"   />

* **Brief Program Analysis**

(1) Analysis of launch File

The program is saved at:[/home/ubuntu/ros2_ws/src/large_models_examples/large_models_examples/vllm_dietitianl.launch.py](../_static/source_code/large_models_examples.zip)
...
The program is saved at: [/home/ubuntu/ros2_ws/src/large_models_examples/large_models_examples/vllm_dietitianl.py](../_static/source_code/large_models_examples.zip)
