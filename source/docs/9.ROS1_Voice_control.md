...
After remotely logging in via NoMachine, click the desktop icon <img src="../_static/media/chapter_9\section_2/image5.png"  style="width:70px" /> to access the configuration interface.
...
Click the icon <img src="../_static/media/chapter_9\section_2/image14.png"  style="width:50px"  /> to open a terminal and enter the command to delete the old files.
