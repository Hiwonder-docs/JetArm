...
<img src="../_static/media/chapter_17/section_1/image2.png" style="width:700px;" class="common_img"/>

(2) The image below shows the assembled configuration of the 6-microphone array.

<img src="../_static/media/chapter_17/section_1/image3.png" style="width:700px;" class="common_img"/>

(3) Connect the 6-CH microphone array to USB Port 2 on the controller, as shown below.

<img src="../_static/media/chapter_17/section_1/image4.png" />
...
To change the recognition language, open the configuration tool by double-clicking the "**Tool**" icon on the desktop <img style="width:70px;" src="../_static/media/chapter_17/section_2/image2.png" />.
...
<img src="../_static/media/chapter_17/section_2/image4.png" class="common_img"/>

<img src="../_static/media/chapter_17/section_2/image5.png" class="common_img"/>

(3) Click "**Apply & Save**" to confirm and save your settings.

<img src="../_static/media/chapter_17/section_2/image6.png" class="common_img"/>
...
(4) Navigate to the path [ros_ws/src/xf_mic_asr_offline/launch](../_static/source_code/xf_mic_asr_offline.zip), right-click on the `mic_init.launch` file, and select the highlighted content.
...
(1) Locate the folder [**ros_ws/src/xf_mic_asr_offline/launch**](../_static/source_code/xf_mic_asr_offline.zip), and right-click `mic_init.launch`, then select `Open With Text Editor`
...
[**ros_ws/src/xf_mic_asr_offline/launch**](../_static/source_code/xf_mic_asr_offline.zip)
...
#### 9.10.1.1 Version Confirmation

Before starting this feature, verify that the correct microphone configuration is set in the system.

After remotely logging in via NoMachine, click the desktop icon <img src="../_static/media/chapter_9\section_2/image5.png"  style="width:70px"   class="common_img" /> to access the configuration interface.

Select the appropriate microphone version configuration according to the hardware.

<img src="../_static/media/chapter_9\section_2/image6.png"  style="width:500px"   class="common_img" />

For the Six-Microphone Circular Array, select xf as the microphone type as shown in the figure.

<img src="../_static/media/chapter_9\section_2/image7.png"  style="width:300px"   class="common_img" />

<img src="../_static/media/chapter_9\section_2/image8.png"  style="width:500px"   class="common_img" />

After making the appropriate selection, click **Apply & Save and Restart Service**.

<img src="../_static/media/chapter_9\section_2/image9.png"  style="width:500px"   class="common_img" />

#### 9.10.1.2 6-Microphone Array Configuration

* **Applying for Offline Speech Package & ID**

Please refer to the steps in [1. Tutorials \3. ROS1 Course \9. Voice Control Lesson \1. Voice Control Basic Lesson \Voice Control Basic Lesson (Ring Microphone Array) \5. Replace Voice Resource Package and APPID](#anchor_9_7) for the microphone configuration.

### 1.2.2 Replacing Offline Speech Resources and ID

Extract the compressed package from the provided materials.

<img src="../_static/media/chapter_9\section_2/image10.png"  style="width:800px"   class="common_img" />

Make sure to locate the folder based on your download path.

Open the folder named **Linux_aitalk_exp1227_21*\*\*\*8f**. The version ID, such as **21\*\*\*\*8f**, may vary depending on the official release. Navigate to the **\bin\msc\res\asr** directory and locate the **common.jet** file. Drag this file onto the desktop of the robot’s system image.

<img src="../_static/media/chapter_9\section_2/image12.png"  style="width:500px"   class="common_img" />

<img src="../_static/media/chapter_9\section_2/image13.png"  style="width:500px"   class="common_img" />

Click the icon <img src="../_static/media/chapter_9\section_2/image14.png"  style="width:50px"   class="common_img" /> to open a terminal and enter the command to delete the old files.

```
rm -rf ~/jetarm/src/xf_mic_asr_offline/config/msc/res/asr/common.jet
```

<img src="../_static/media/chapter_9\section_2/image15.png"  style="width:500px"   class="common_img" />

Enter the command to replace the file.

```
cp ~/Desktop/common.jet ~/jetarm/src/xf_mic_asr_offline/config/msc/res/asr/
```

<img src="../_static/media/chapter_9\section_2/image16.png"  style="width:500px"   class="common_img" />

Enter the following command to edit the initialization content:

```
gedit ~/jetarm/src/xf_mic_asr_offline/launch/mic_init.launch
```

<img src="../_static/media/chapter_9\section_2/image17.png"  style="width:500px"   class="common_img" />

Set the appid in the red box to the one obtained from iFlytek, then press **Ctrl+S** to save.

<img src="../_static/media/chapter_9\section_2/image18.png"  style="width:500px"   class="common_img" />
...
[/home/jetarm/src/xf_mic_asr_offline/scripts/voice_control_sorting.py](../_static/source_code/xf_mic_asr_offline.zip)
...
(2) Double-click to open the command-line terminal. Execute the command ‘sudo systemctl stop jetarm_bringup.service’ to terminate the auto-start service. If you are required to enter the password, please input ‘hiwonder’.
...
(9) Following the above function, it is essential to enable the app service; otherwise, the app functions may be impacted. Execute the command 'sudo systemctl start jetarm_bringup.service' and provide the password 'hiwonder' when prompted.
...
<table border="1">
  ...
  <tbody>
    <tr>
      <td rowspan="4">Hello Hiwonder</td>  <!-- 合并第1-4行 -->
      <td>Sort red</td>
      <td>Place the red block to red sorting area</td>
    </tr>
    <tr>
      <!-- 第2行第一列已被合并 -->
      <td>Sort green</td>
      <td>Place the green block to green sorting area</td>
    </tr>
    <tr>
      <!-- 第3行第一列已被合并 -->
      <td>Sort blue</td>
      <td>Place the blue block to blue sorting area</td>
    </tr>
    <tr>
      <!-- 第4行第一列已被合并 -->
      <td>Stop sorting/ Stop color sorting</td>
...
[/home/jetarm/src/xf_mic_asr_offline/launch/voice_control_color_sorrting.launch](../_static/source_code/xf_mic_asr_offline.zip)
...
[/home/jetarm/src/xf_mic_asr_offline/scripts/voice_control_color_sorting.py](../_static/source_code/xf_mic_asr_offline.zip)
...
First, check if the voice command is either `sort red` or `sorting red object`.
...
For learning about the PID algorithm, refer to [**4. ROS+OpenCV Course/ 4.2 Target Tracking**](4.ROS1_ROS+OpenCV_Course.md#target-tracking)
...
4. If there is an incorrect recognition result, refer to the instructions in [**1. Getting Ready/ JetArm User Manual/ 1.5 Color Threshold Setting**](1.Getting_Ready.md#color-threshold-setting) to adjust the color threshold for a more precise outcome.
:::
...
(3) Execute the command ‘sudo systemctl stop jetarm_bringup.service’ to disable auto-start service. If you are required to input the password, please enter ‘hiwonder’.
...
[/home/jetarm/src/xf_mic_asr_offline/launch/voice_control_color_track.launch](../_static/source_code/xf_mic_asr_offline.zip)
...
[**/home/ubuntu/jetarm/src/xf_mic_asr_offline/scripts/voice_control_color_track.py**](../_static/source_code/xf_mic_asr_offline.zip)

The program flowchart is as below:

<img src="../_static/media/chapter_9/section_2/image68.png" class="common_img" />
