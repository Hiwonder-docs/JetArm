...
(1) Extract the virtual machine software package saved in  [Virtual Machine Installation Pack](https://docs.hiwonder.com/projects/JetArm/en/latest/docs/resources_download.html)
...
(2) In the popup window, locate the image file under the directory [**2 Tools/6 Voice Recognition Environment Set Up Tool/6-Channel Microphone Array Image**](https://docs.hiwonder.com/projects/JetArm/en/latest/docs/resources_download.html). Open the image file (the actual name of the image may vary; this image is for reference only).
...
[/home/jetarm/src/xf_mic_asr_offline/scripts/voice_control_sorting.py](../_static/source_code/09/xf_mic_asr_offline_scripts.zip)
...
* In case of an incorrect recognition result, follow the instructions provided in [**1. Getting Ready/ JetArm User Manual/ 1.5 Color Threshold Setting**](https://docs.hiwonder.com/projects/JetArm/en/latest/docs/1.Getting_Ready.html#color-threshold-setting) to adjust the color threshold for a more accurate outcome.
  :::
...
[/home/jetarm/src/xf_mic_asr_offline/launch/voice_control_color_sorrting.launch](../_static/source_code/09/xf_mic_asr_offline_launch.zip)
...
[/home/jetarm/src/xf_mic_asr_offline/scripts/voice_control_color_sorting.py](../_static/source_code/09/xf_mic_asr_offline_scripts.zip)
...
[/home/jetarm/src/xf_mic_asr_offline/launch/voice_control_color_track.launch](../_static/source_code/09/xf_mic_asr_offline_launch.zip)
