...
<img src="../_static/media/chapter_18/section_1/media/image2.png" style="width:700px;" class="common_img"/>

(2) The image below shows the assembled configuration of the 6-microphone array.

<img src="../_static/media/chapter_18/section_1/media/image3.png" style="width:700px;" class="common_img"/>
...
To change the recognition language, open the configuration tool by double-clicking the "**Tool**" icon on the desktop <img style="width:70px;" src="../_static/media/chapter_18/section_2/media/image2.png" />.
