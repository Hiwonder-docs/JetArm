...
(3) Open a new terminal <img src="../_static/media/chapter_20/image33.png" />,and enter the following command and press Enter to enable color sorting feature.
...
(3) Open a new terminal window <img src="../_static/media/chapter_20/image33.png" />, enter the following command, and press Enter to launch the tag sorting feature.
