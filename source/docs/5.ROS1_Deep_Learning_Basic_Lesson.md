...
|:--:|:--:|:--:|
| <img src="../_static/media/chapter_5/section_1/media/image51.png"  /> | Ctrl+U | Select the directory where the picture is saved. |
| <img src="../_static/media/chapter_5/section_1/media/image52.png"  /> | Ctrl+R | Select the directory where the calibration data is saved. |
| <img src="../_static/media/chapter_5/section_1/media/image53.png"  /> | W | Create annotation box |
| <img src="../_static/media/chapter_5/section_1/media/image54.png"  /> | Ctrl+S | Save annotation |
| <img src="../_static/media/chapter_5/section_1/media/image55.png"  /> | A | Switch to the previous image |
| <img src="../_static/media/chapter_5/section_1/media/image56.png"  /> | D | Switch to the next image |
