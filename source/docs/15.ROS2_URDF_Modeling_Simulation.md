# 15. ROS2-URDF Modeling Simulation

<p id="anchor_15_1"></p>

## 15.1 Virtual Machine Installation and Import

### 15.1.1 Virtual Machine Software Installation
...
<img src="../_static/media/chapter_15/section_1/image4.png" class="common_img"  />

(2) After unzipping, locate the virtual machine folder and double-click the executable file (with the "**.exe**" extension).

<img class="common_img" src="../_static/media/chapter_15/section_1/image5.png"   />

(3) Follow the on-screen instructions to complete the installation of the virtual machine.

<img class="common_img" src="../_static/media/chapter_15/section_1/image6.png"   />

<img class="common_img" src="../_static/media/chapter_15/section_1/image7.png"   />

<img class="common_img" src="../_static/media/chapter_15/section_1/image8.png"   />

<img class="common_img" src="../_static/media/chapter_15/section_1/image9.png"   />

<img class="common_img" src="../_static/media/chapter_15/section_1/image10.png"   />

<img class="common_img" src="../_static/media/chapter_15/section_1/image11.png"   />

<img class="common_img" src="../_static/media/chapter_15/section_1/image12.png"   />
...
<img class="common_img" src="../_static/media/chapter_15/section_1/image13.png"  />
...
<img class="common_img" src="../_static/media/chapter_15/section_1/image14.png"  />

(2) Click on `Administrative Tools` and then double-click on `Services`.

<img class="common_img" src="../_static/media/chapter_15/section_1/image15.png"  />

<img class="common_img" src="../_static/media/chapter_15/section_1/image16.png"  />

(3) Locate the VMware-related services as shown in the image below.

<img class="common_img" src="../_static/media/chapter_15/section_1/image17.png"  />

(4) Right-click on the `Start` button and select it to start all VMware-related services.

<img class="common_img" src="../_static/media/chapter_15/section_1/image18.png"  />

* **VirtualBox Installation**

(1) Open the software installation package in the same directory and click `Next`.

<img class="common_img" src="../_static/media/chapter_15/section_1/image19.png"  />
...
<img class="common_img" src="../_static/media/chapter_15/section_1/image22.png"  />

<img class="common_img" src="../_static/media/chapter_15/section_1/image23.png"  />

(5) Once the installation is complete, click `Finish`.

<img class="common_img" src="../_static/media/chapter_15/section_1/image24.png"  />

### 15.1.2 Virtual System Image Import

(1) In the software interface, click on `Open Virtual Machine`.

<img src="../_static/media/chapter_15/section_1/image25.png"  />

(2) Locate the required virtual machine file in the same directory, and open it.

<img class="common_img" src="../_static/media/chapter_15/section_1/image26.png"  />

(3) Select a storage path and click `Import`. Wait for the import to complete.

<img src="../_static/media/chapter_15/section_1/image27.png"  />

<img src="../_static/media/chapter_15/section_1/image28.png"  />

(4) Once the import is finished, you can start using the virtual machine.

### 15.1.3 Virtual Machine Settings

(1) Locate the virtual machine you just imported and click `Edit Virtual Machine Settings`.

<img src="../_static/media/chapter_15/section_1/image29.png"  />

(2) Click on `Network Adapter` and select `Bridged Mode`.

<img class="common_img" src="../_static/media/chapter_15/section_1/image30.png"  />
...
<img class="common_img" src="../_static/media/chapter_15/section_1/image31.png"  />
...
### 15.2.1 Package Import (Performed on Virtual Machine)

(1) Start the virtual machine. Click the system desktop icon <img src="../_static/media/chapter_15/section_1/image33.png" style="width:70px" /> to open the command-line terminal.

(2) Click the `Home` icon <img src="../_static/media/chapter_15/section_1/image34.png" style="width:90px" /> on the desktop to enter the Home directory.

(3) Locate the [Simulations](resources_download.md) compressed file in the same directory. Drag the compressed file into the Home directory of the virtual machine.
...
<img src="../_static/media/chapter_15/section_1/image35.png"  />
...
<img src="../_static/media/chapter_15/section_1/image39.png"  />
...
<img src="../_static/media/chapter_15/section_1/image42.png" class="common_img" />
...
### 15.2.2 Network Configuration (Performed in Robot System Desktop)
...
(1) Start the robot and open a terminal <img src="../_static/media/chapter_15/section_1/image46.png" style="width:70px" /> on the desktop.
...
<img src="../_static/media/chapter_15/section_1/image48.png"  />
...
<img src="../_static/media/chapter_15/section_1/image49.png"  />
...
### 15.2.3 Device ID Configuration (To Be Performed on the Virtual Machine)
...
(1) Start the robot and open a terminal <img src="../_static/media/chapter_15/section_1/image46.png" style="width:70px" /> from the desktop.

(2) The terminal will display the device's `DOMAIN_ID`, as shown below:

<img class="common_img" src="../_static/media/chapter_15/section_1/image50.png"  />

For example, if the `DOMAIN_ID` is 23, we will configure the virtual machine accordingly.

(3) Start the virtual machine and open a terminal <img src="../_static/media/chapter_15/section_1/image33.png" style="width:70px" /> from the desktop.
...
<img src="../_static/media/chapter_15/section_1/image52.png"  />

<img class="common_img" src="../_static/media/chapter_15/section_1/image53.png"  />
...
<img class="common_img" src="../_static/media/chapter_15/section_1/image54.png"  />

## 15.3 URDF Model 

:::Note
This tutorial is based on configuration and simulation within a virtual machine. If the virtual machine is not yet installed, please first refer to Section [15.1 Virtual Machine Installation and Import](#anchor_15_1).
:::

### 15.3.1 URDF Model Introduction
...
### 15.3.2 Comparison between Xacro and URDF Model
...
### 15.3.3 Install URDF Dependency
...
<p id="anchor_15_3_4"></p>

### 15.3.4 URDF Model Basic Syntax
...
<img class="common_img" src="../_static/media/chapter_15/section_2/image10.png"  />
...
:::Note
To learn about the type of the joint, please refer to [joint](#anchor_15_3_4_joint)
:::
...
## 15.4 ROS Robot URDF Model Instructions

### 15.4.1 Preparation

To understand the URDF model, you can refer to the "**[16.3.4 URDF Model Basic Syntax](#anchor_15_3_4)**". This section provides a brief analysis of the robot model code and component models.

### 15.4.2 Viewing the Robot Model Code

(1) Start the virtual machine and click the icon <img src="../_static/media/chapter_15/section_2/image31.png" style="width:70px" /> to open the command-line terminal.
...
### 15.4.3 Brief Analysis of the Robot's Main Model
...
## 15.5 MoveIt2 Simulation

### 15.5.1 MoveIt2 Kinematics Design
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image11.png"   />
...
If aₙ represents the common perpendicular between Zₙ and Zₙ₋₁, then the direction of Xₙ will be along aₙ.
...
(1) Start the virtual machine. Click on <img src="../_static/media/chapter_15/section_3/image13.png"  /> on the system desktop to open the command line terminal.
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image15.png"  />
...
(1) Start the virtual machine. Click the icon <img src="../_static/media/chapter_15/section_3/image17.png"  /> on the system desktop to open the terminal command line.
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image19.png" style="width:100%;" />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image20.png" style="width:100%;"/>

<img class="common_img" src="../_static/media/chapter_15/section_3/image21.png"  />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image23.png"  />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image24.png"  />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image25.png"  />

(3) Planning Groups

Joint groups are used to define the various joint components required to assemble the robot.

<img class="common_img" src="../_static/media/chapter_15/section_3/image26.png"  />

(4) Robot Poses

Define custom pose names for the robot and specify the joint groups involved in achieving each pose.

<img class="common_img" src="../_static/media/chapter_15/section_3/image27.png"  />

(5) End Effectors

End effector (robot arm's gripper)

<img class="common_img" src="../_static/media/chapter_15/section_3/image28.png"  />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image33.png"  />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image34.png"  />

### 15.5.3 MoveIt2 Control
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image36.png"  />

* **Control Instructions**

(1) In the MoveIt2 Debugging Area, find and click the `Planning` section.

<img class="common_img" src="../_static/media/chapter_15/section_3/image37.png"  />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image38.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image39.png" style="width:600px" />

(4) Drag the sliders for the corresponding joints to adjust their angles individually.

<img class="common_img" src="../_static/media/chapter_15/section_3/image40.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image41.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image42.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image43.png" style="width:600px" />

(7) Then, click the `Execute` option to make both the simulation model and robotic arm follow the planned motion path.

<img class="common_img" src="../_static/media/chapter_15/section_3/image44.png" style="width:600px" />

<img class="common_img" src="../_static/media/chapter_15/section_3/image45.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image46.png" style="width:600px" />

(9) To close this mode, press `Ctrl+C` in the terminal. If the process fails to stop, try again.

### 15.5.4 MoveIt2 Random Movement 
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image47.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image48.png" style="width:600px" />

(4) Click the dropdown menu under `Goal State` and choose the desired target position.

<img class="common_img" src="../_static/media/chapter_15/section_3/image49.png" style="width:600px" />

(5) The parameter list in the dropdown menu is as follows:

<img class="common_img" src="../_static/media/chapter_15/section_3/image50.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image51.png"  />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image52.png" style="width:600px" />

(8) To exit this mode, press `Ctrl+C` in the terminal. If the process fails to stop, try again.

### 15.5.5 MoveIt2 Cartesian Path
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image53.png"   />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image54.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image55.png" style="width:600px" />
...
### 15.5.6 MoveIt2 Collision Detection
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image56.png" style="width:600px" />

(4) Once the robot arm's path is planned, click the `Scene Objects` section to add a collision model.

<img class="common_img" src="../_static/media/chapter_15/section_3/image57.png" style="width:600px" />

(5) The section is divided into 4 areas, as described below:

<img class="common_img" src="../_static/media/chapter_15/section_3/image58.png" style="width:600px"  />

(6) Click the `Box` dropdown menu and select a collision model. Here, we will use the `Sphere` model as an example.

<img class="common_img" src="../_static/media/chapter_15/section_3/image59.png" style="width:600px" />

<img class="common_img" src="../_static/media/chapter_15/section_3/image60.png" style="width:600px" />

(7) Click the plus icon to add the currently selected collision model.

<img class="common_img" src="../_static/media/chapter_15/section_3/image61.png" style="width:600px" />

The model will be placed at the robot's base by default, as shown in the image below:

<img class="common_img" src="../_static/media/chapter_15/section_3/image62.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image63.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image64.png" style="width:600px" />

(10) Click the `Planning` section and check the `Collision-aware IK` option to enable the collision detection for the model.

<img class="common_img" src="../_static/media/chapter_15/section_3/image65.png" style="width:600px" />

(11) Next, click `Plan & Execute` to begin moving along the planned path. When the following prompt appears, select `Yes`.

<img class="common_img" src="../_static/media/chapter_15/section_3/image66.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image67.png" style="width:600px" />

(6) Above the model selection, adjust the initial size of the object model in meters, as shown below.

<img class="common_img" src="../_static/media/chapter_15/section_3/image68.png"  style="width:600px" />

(7) After adjusting, click the "**+**" button to add the currently configured object model to the scene.

<img class="common_img" src="../_static/media/chapter_15/section_3/image69.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image70.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image71.png" style="width:600px" />

(10) In addition to using arrow dragging, you can also make adjustments in the "**Position and Size**" adjustment area.

<img class="common_img" src="../_static/media/chapter_15/section_3/image72.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image73.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image74.png" style="width:600px" />

(13) If you wish to close this feature, press `Ctrl+C` in the terminal. If the closing fails, please try again.

### 15.5.8 MoveIt2 Trajectory Planning
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image75.png" style="width:600px" />

(5) Fine-tune Joint Angles: Drag the corresponding sliders to adjust the angles of the individual joints.

<img class="common_img" src="../_static/media/chapter_15/section_3/image76.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image77.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image78.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_3/image79.png"  />
...
### 15.5.9 Simulation and Robotic Arm Synchronization
...
(1) Start the Robot: Click on the system desktop icon <img src="../_static/media/chapter_15/section_3/image17.png"  /> to open the command terminal, then enter the command to disable the auto-start service:
...
(1) Start the Virtual Machine: Click the system desktop icon <img src="../_static/media/chapter_15/section_3/image17.png"  /> to open the command terminal.
...
###  15.6.2 Gazebo GUI Introduction
...
### 15.6.3 Gazebo xacro Model Visualization
...
(1) Start the virtual machine. Click-on the system desktop icon <img src="../_static/media/chapter_15/section_4/image3.png"  /> to execute the command-line terminal.
...
<img class="common_img" src="../_static/media/chapter_15/section_4/image10.png"  />
...
(4) Selection tool <img src="../_static/media/chapter_15/section_4/image11.png"  />: This is Gazebo's default tool, used to select models.

<img class="common_img" src="../_static/media/chapter_15/section_4/image12.png" style="width:600px" />

(5) Move Tool <img src="../_static/media/chapter_15/section_4/image13.png"  />: Use this tool to select a model and drag the three axes to control its movement.

<img class="common_img" src="../_static/media/chapter_15/section_4/image14.png" style="width:600px" />

<img class="common_img" src="../_static/media/chapter_15/section_4/image15.png" style="width:600px" />

(6) Rotate Tool <img src="../_static/media/chapter_15/section_4/image16.png"  />: Use this tool to select a model and drag the three axes to control its rotation.

<img class="common_img" src="../_static/media/chapter_15/section_4/image17.png" style="width:600px" />

For more information about Gazebo, visit the official website: http://gazebosim.org/

### 15.6.4 Gazebo and MoveIt2 Simulation Integration

* **Enable Simulation Service**

(1) Start the virtual machine. Click-on <img src="../_static/media/chapter_15/section_4/image5.png"  /> to initiate the command-line terminal.
...
<img class="common_img" src="../_static/media/chapter_15/section_4/image20.png"  />

① In the MoveIt2 Debugging Area, find and click on the `Planning` section.

<img class="common_img" src="../_static/media/chapter_15/section_4/image21.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_4/image22.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_4/image23.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_4/image24.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_4/image25.png" style="width:600px" />

⑤ Next, click `Execute` to make both the simulation model and the robotic arm follow the planned path.

<img class="common_img" src="../_static/media/chapter_15/section_4/image26.png" style="width:600px" />

<img class="common_img" src="../_static/media/chapter_15/section_4/image27.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_4/image28.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_4/image31.png" style="width:600px" />

<img class="common_img" src="../_static/media/chapter_15/section_4/image32.png" style="width:600px" />

③ Once the motion trajectory is planned, return to `Planning` and click `Plan & Execute` to execute the movement.

<img class="common_img" src="../_static/media/chapter_15/section_4/image33.png"  />