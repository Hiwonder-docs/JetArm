...
:::Note
This tutorial is based on configuration and simulation within a virtual machine. If the virtual machine is not yet installed, please first refer to Section [15.1 Virtual Machine Installation and Import](#anchor_16_1).
:::
...
<img class="common_img" src="../_static/media/chapter_15/section_4/media/image4.png"  />
...
(1) Start the virtual machine. Click-on the system desktop icon <img src="../_static/media/chapter_15/section_4/media/image3.png"  /> to execute the command-line terminal.
...
<img class="common_img" src="../_static/media/chapter_15/section_4/media/image7.png"  />
...
<img class="common_img" src="../_static/media/chapter_15/section_4/media/image10.png"  />
...
(4) Selection tool <img src="../_static/media/chapter_15/section_4/media/image11.png"  />: This is Gazebo's default tool, used to select models.

<img class="common_img" src="../_static/media/chapter_15/section_4/media/image12.png" style="width:600px" />

(5) Move Tool <img src="../_static/media/chapter_15/section_4/media/image13.png"  />: Use this tool to select a model and drag the three axes to control its movement.

<img class="common_img" src="../_static/media/chapter_15/section_4/media/image14.png" style="width:600px" />

<img class="common_img" src="../_static/media/chapter_15/section_4/media/image15.png" style="width:600px" />

(6) Rotate Tool <img src="../_static/media/chapter_15/section_4/media/image16.png"  />: Use this tool to select a model and drag the three axes to control its rotation.

<img class="common_img" src="../_static/media/chapter_15/section_4/media/image17.png" style="width:600px" />
...
(1) Start the virtual machine. Click-on <img src="../_static/media/chapter_15/section_4/media/image5.png"  /> to initiate the command-line terminal.
...
<img class="common_img" src="../_static/media/chapter_15/section_4/media/image20.png"  />

① In the MoveIt2 Debugging Area, find and click on the `Planning` section.

<img class="common_img" src="../_static/media/chapter_15/section_4/media/image21.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_4/media/image22.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_4/media/image23.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_4/media/image24.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_4/media/image25.png" style="width:600px" />

⑤ Next, click `Execute` to make both the simulation model and the robotic arm follow the planned path.

<img class="common_img" src="../_static/media/chapter_15/section_4/media/image26.png" style="width:600px" />

<img class="common_img" src="../_static/media/chapter_15/section_4/media/image27.png" style="width:600px" />
...
<img class="common_img" src="../_static/media/chapter_15/section_4/media/image28.png" style="width:600px" />

⑦ You can also observe that the path planned in MoveIt2 is synchronized with the Gazebo interface.

<img class="common_img" src="../_static/media/chapter_15/section_4/media/image29.png"  />

(2) Gripper Control

① To control the gripper movement, select `gripper` in the `Planning Group`.

<img class="common_img" src="../_static/media/chapter_15/section_4/media/image30.png"  />

② Drag the `r joint` to control the gripper's rotation.

<img class="common_img" src="../_static/media/chapter_15/section_4/media/image31.png" style="width:600px" />

<img class="common_img" src="../_static/media/chapter_15/section_4/media/image32.png" style="width:600px" />

③ Once the motion trajectory is planned, return to `Planning` and click `Plan & Execute` to execute the movement.

<img class="common_img" src="../_static/media/chapter_15/section_4/media/image33.png"  />