# 16. ROS2-Robot Arm Depth Camera Application

## 16.1 Depth Map Pseudo-Color Processing
...
(1) Double-click <img src="../_static/media/chapter_15/section_1/image33.png" style="width:70px" /> to open the command line terminal, and execute the following command to close the auto-start service. 

```
sudo systemctl stop start_app_node.service
```

(2) Open a new terminal by clicking <img src="../_static/media/chapter_16/section_1/image1.png" style="width:70px" /> Execute the command below and hit Enter to run the game.
...
### 16.1.4 Launch File Analysis

The Launch file is saved in

**[/home/ubuntu/ros2_ws/src/example/example/rgbd_function/get_depth_rgb_img.launch.py](../_static/source_code/rgbd_function.zip)**
...
### 16.1.5 Python Source Code Analysis

The source code is saved in

**[/home/ubuntu/ros2_ws/src/example/example/rgbd_function/include/get_depth_rgb_img.py](../_static/source_code/rgbd_function.zip)**
...
(1) Double-click <img src="../_static/media/chapter_15/section_1/image33.png" style="width:0.5625in;height:0.48958in" /> to open the command line terminal, and execute the following command to terminate the auto-start service.

```
sudo systemctl stop start_app_node.service
```

(2) Open a new terminal <img src="../_static/media/chapter_16/section_1/image1.png" style="width:0.5625in;height:0.48958in" />Run the command below and hit Enter to run the game program.
...
(4) After completing the game experience, you need to start the app service <img src="../_static/media/chapter_15/section_1/image33.png" style="width:0.5625in;height:0.48958in" /> (if not started, it will affect the subsequent usage of the app features). In the terminal, enter the command and press Enter to start the app service. Wait for a moment, and the service will be activated.
...
### 16.2.4 Launch File Analysis

The Launch file is saved in

**[/home/ubuntu/ros2_ws/src/example/example/rgbd_function/distance_measure.launch.py](../_static/source_code/rgbd_function.zip)**
...
### 16.2.5 Python Source Code Analysis

The source code file locates in

**[/home/ubuntu/ros2_ws/src/example/example/rgbd_function/include/distance_measure.py](../_static/source_code/rgbd_function.zip)**

The program flowchart is as below:

<img class="common_img" src="../_static/media/chapter_16/section_1/image33.png" />
...
(5) Initialize an image queue with a maximum capacity of 2 to buffer incoming sensor messages.
(6) Create a publisher for sending servo position commands on the /servo_controller topic.

(7) Establish a service client to interact with the /controller_manager/init_finish service, which signals when controller initialization is complete.

(8) Wait for the /controller_manager/init_finish service to become available before proceeding.

(9) Create a separate service client to enable or disable the LDP feature of the depth camera via the /depth_cam/set_ldp_enable service.

(10) Wait for the /depth_cam/set_ldp_enable service to be accessible prior to sending requests.

(11) Create an RGB image subscriber to the /depth_cam/rgb/image_raw topic using message_filters.Subscriber.

(12) Create a depth image subscriber to the /depth_cam/depth/image_raw topic using message_filters.Subscriber.

(13) Instantiate an ApproximateTimeSynchronizer to synchronize the RGB and depth images, allowing a maximum time difference of 0.5 seconds and a queue size of 4.

(14) sync.registerCallback(self.multi_callback): with the synchronizer to be triggered when synchronized image pairs arrive.

(15) Create a ReentrantCallbackGroup to allow concurrent execution of callbacks within the group.

(16) self.timer = self.create_timer(0.0, self.init_process, callback_group=timer_cb_group) : Create a timer with zero initial delay that triggers the init_process method, assigning it to the timer_cb_group.

(17) self.target_point = None : Initialize self.target_point to None to store coordinates from mouse click events.

(18) self.last_event = 0: Initialize self.last_event to 0 to record the timestamp of the last event.

(19) cv2.namedWindow("depth"): Use OpenCV to create a window named "depth" for displaying depth images.

(20) cv2.setMouseCallback('depth', self.click_callback): Set a mouse callback function click_callback on the "depth" window to handle mouse click events.

(21) threading.Thread(target=self.main, daemon=True).start(): Start a daemon thread to run the main loop method main.
...
(1) Double-click <img src="../_static/media/chapter_15/section_1/image33.png" style="width:0.5625in;height:0.48958in" /> to open the command line terminal, and execute the command to close the auto-start service.

```
sudo systemctl stop start_app_node.service
```

(2) Open a new terminal by clicking <img src="../_static/media/chapter_16/section_1/image1.png" style="width:0.5625in;height:0.48958in" />Run the following command and hit Enter to run the program.
...
(4) Following the above function, it is essential to enable the app service<img src="../_static/media/chapter_15/section_1/image33.png" style="width:0.5625in;height:0.48958in" />; otherwise, the app functions may be impacted. Execute the command to initiate the app service.
...
<img class="common_img" src="../_static/media/chapter_16/section_1/image44.png" />

### 16.3.4 Launch File Analysis

The Launch file is saved in

[/home/ubuntu/ros2_ws/src/example/example/rgbd_function/rgb_depth_to_pointcloud.launch.py](../_static/source_code/rgbd_function.zip)
...
### 16.3.5 Python Source Code Analysis

The source code file locates in

[/home/ubuntu/ros2_ws/src/example/example/rgbd_function/include/rgb_depth_to_pointcloud.py](../_static/source_code/rgbd_function.zip)

The program flowchart is as below:

<img class="common_img" src="../_static/media/chapter_16/section_1/image48.png" />
...
(30) `sync.registerCallback(self.multi_callback)`: Register the `multi_callback` function to handle the synchronized data.

(31) `self.timer = self.create_timer(0.0, self.init_process, callback_group=timer_cb_group)`: Create a timer to invoke the `init_process` method for the initialization process, using the reentrant callback group.
...
## 16.4 Height Detection and Gripping
...
(1) Double-click <img src="../_static/media/chapter_15/section_1/image33.png" style="width:0.5625in;height:0.48958in" /> to open the command line terminal, and execute the following command to disable the auto-start service.
...
(4) Following the above function, it is essential to enable the app service <img src="../_static/media/chapter_15/section_1/image33.png" style="width:0.5625in;height:0.48958in" />; otherwise, the app functions may be impacted. Execute the following command.
...
<img src="../_static/media/chapter_16/section_1/1.gif" class="common_img"/>

### 16.4.4 Launch File Analysis

The Launch file is saved in

[/home/ubuntu/ros2_ws/src/example/example/rgbd_function/remove_too_high.launch.py](../_static/source_code/rgbd_function.zip)
...
### 16.4.5 Python Source Code Analysis

The source code file is saved in

[/home/ubuntu/ros2_ws/src/example/example/rgbd_function/include/remove_too_high.py](../_static/source_code/rgbd_function.zip)

The program flowchart is as below:

<img src="../_static/media/chapter_16/section_1/image61.png" class="common_img"/>
...
(2) Open a new terminal <img src="../_static/media/chapter_16/section_1/image1.png" style="width:0.5625in;height:0.48958in" />and run the command below and hit Enter to run the game program.
...
<img class="common_img" src="../_static/media/chapter_16/section_1/2.gif" />

### 16.5.4 Launch File Analysis

Launch file is saved in

[/home/ubuntu/ros2_ws/src/example/example/rgbd_function/track_and_grab.launch.py](../_static/source_code/rgbd_function.zip)
...
### 16.5.5 Python Source Code Analysis

The source code file is saved in [/home/ubuntu/ros2_ws/src/example/example/rgbd_function/include/track_and_grab.py](../_static/source_code/rgbd_function.zip)

The program flowchart is as below:

<img class="common_img" src="../_static/media/chapter_16/section_1/image84.png" />
...
(2) Open a new terminal by clicking <img src="../_static/media/chapter_16/section_1/image1.png" style="width:0.5625in;height:0.48958in" />,and run the following command, and hit Enter to execute the game program.
...
<img class="common_img" src="../_static/media/chapter_16/section_1/3.gif" />

### 16.6.4 Launch File Analysis

The Launch file is saved in

[/home/ubuntu/ros2_ws/src/example/example/rgbd_function/shape_recognition.launch.py](../_static/source_code/rgbd_function.zip)
...
### 16.6.5 Python Source Code Analysis

The source code file is saved in

[/home/ubuntu/ros2_ws/src/example/example/rgbd_function/include/shape_recognition.py](../_static/source_code/rgbd_function.zip)

The program flowchart is as below:

<img class="common_img" src="../_static/media/chapter_16/section_1/image104.png" />
