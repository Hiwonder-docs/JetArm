...
(1) Start the robot arm, and access the robot system desktop using NoMachine. To get detailed instructions on remote control software connection, please refer to the tutorials saved in [1.Getting Ready(JetArm User Manual)-> 1.6 Development Environment Setup and Configuration](1.Getting_Ready.md#development-environment-setup-and-configuration).

(2) Click-on <img src="../_static/media/chapter_4/section_1/image5.png"  /> to open the command-line terminal, then execute the following command，Then hit Enter and type the password 'hiwonder' to terminate the auto-start service.
...
[/home/hiwonder/jetarm/src/jetarm_example/src/1.camera_topic_invoke/camera_topic_invoke.launch](../_static/source_code/camera_topic_invoke.zip)
...
[/home/hiwonder/jetarm/src/jetarm_example/src/1.camera_topic_invoke/camera_topic_invoke.py](../_static/source_code/camera_topic_invoke.zip)
...
The Gemini camera's parameters can be calibrated, eliminating the need for manual calibration. For more information on camera calibration, please refer to Depth Camera Basic Lesson.
...
<img class="common_img" src="../_static/media/chapter_4/section_1/image26.jpeg"   />
...
<img class="common_img" src="../_static/media/chapter_4/section_1/image27.png"  />
...
<img class="common_img" src="../_static/media/chapter_4/section_1/image28.png"  />
...
① Start the robot arm, and access the robot system desktop using NoMachine according to the tutorials saved in [1. Getting Ready(JetArm User Manual)->1.6  Development Environment Setup and Configuration](1.Getting_Ready.md#development-environment-setup-and-configuration).

② Double-click <img  src="../_static/media/chapter_4/section_1/image5.png"  /> to open the command-line terminal, and execute the command 'sudo systemctl stop jetarm_bringup.service', then hit Enter and type the password **'hiwonder'** to terminate the app auto-start service.
...
Launch file is saved in this folder:[/home/ubuntu/jetarm/src/jetarm_example/src/3.Color_space_conversion/color_threshold.launch](../_static/source_code/color_space_conversion.zip)
...
The source code file is saved in:[/home/ubuntu/jetarm/src/jetarm_example/src/3.Color_space_conversion/color_threshold.py](../_static/source_code/color_space_conversion.zip)

The program flow chart is as below:

<img class="common_img" src="../_static/media/chapter_4/section_1/image38.png"   />
...
② Double-click <img  src="../_static/media/chapter_4/section_1/image5.png"  /> to open the command-line terminal. Execute the command below to disable the app auto-start service.
...
<img class="common_img" src="../_static/media/chapter_4/section_1/image49.png"   />
...
The Launch file locates in:[/home/ubuntu/jetarm/src/jetarm_example/src/3.Color_space_conversion/color_space.launch](../_static/source_code/color_space_conversion.zip)
...
The source code file is stored in [/home/ubuntu/jetarm/src/jetarm_example/src/3.Color_space_conversion/color_space.py](../_static/source_code/color_space_conversion.zip)
...
② Double-click <img  src="../_static/media/chapter_4/section_1/image5.png"  /> to open the command-line terminal. Execute the command below, and hit Enter to disable the app auto-start service.
...
<img class="common_img" src="../_static/media/chapter_4/section_1/image59.png"  />
...
The launch file is saved in [/home/ubuntu/jetarm/src/jetarm_example/src/3.Color_space_conversion/color_detection.launch](../_static/source_code/color_space_conversion.zip)
...
[/home/ubuntu/jetarm/src/jetarm_example/src/3.Color_space_conversion/color_detection.py](../_static/source_code/color_space_conversion.zip)
...
(1) Start the robot arm, and access the robot system desktop using NoMachine according to the tutorials saved in [1. Getting Ready( JetArm User Manual)->1.6 Development Environment Setup and Configuration](1.Getting_Ready.md#development-environment-setup-and-configuration).

(2) Double-click <img  src="../_static/media/chapter_4/section_1/image5.png"  /> to open the command-line terminal. Execute the command, and hit Enter to disable the app auto-start service.
...
<img class="common_img" src="../_static/media/chapter_4/section_1/image71.png"  />

(5) If you need to terminate the running program, press short-cut '**Ctrl+C**'. If the program fails to run, please retry.

(6) After using the previous function, it is necessary to restart the app service; otherwise, subsequent app operations may be affected. 6)Execute the command 'sudo systemctl start jetarm_bringup.service' and press Enter to initiate the app service. Then enter the password **'hiwonder'**. When the robot arm restores initial pose and emits a beep sound, the service is restarted successfully.
...
Launch file is saved in this path:[/home/ubuntu/jetarm/src/jetarm_example/src/4.Pixel_coordinate_calculation/pixel_coordinate_calculation.launch](../_static/source_code/pixel_coordinate_calculation.zip)
...
[/home/hiwonder/jetarm/src/jetarm_example/src/Simple_library/color_detection_base.py](../_static/source_code/Simple_library.zip)

The program flow chart is as below:

<img class="common_img" src="../_static/media/chapter_4/section_1/image77.png"   />
...
The source code is saved in: [/home/jetarm/src/jetarm_example/src/4.Pixel_coordinate_calculation/pixel_coordinate_calculation.py](../_static/source_code/pixel_coordinate_calculation.zip)

The program flowchart is as below:

<img class="common_img" src="../_static/media/chapter_4/section_1/image92.png"   />
...
<img class="common_img" src="../_static/media/chapter_4/section_1/image93.png"  />
...
(2) Double-click <img src="../_static/media/chapter_4/section_1/image5.png"  /> to open the command-line terminal, and execute the command 'sudo systemctl stop jetarm_bringup.service', then hit Enter and type the password **'hiwonder'** to terminate the app auto-start service.
...
<img class="common_img" src="../_static/media/chapter_4/section_1/image108.png"  />

(5) If you need to terminate the program, please use short-cut 'Ctrl+C'. If the program fails to stop, please retry.

(6) After running the previous program, you need to restart the app service by executing this command 'sudo systemctl start jetarm_bringup.service'. After you input the command, hit Enter and type the password **'hiwonder'**. Once the robot arm restores initial pose and emits a beep sound, the service is restarted successfully.
...
[/home/hiwonder/jetarm/src/jetarm_example/src/5.Object_attitude_calculation/object_attitude_calculation.py](../_static/source_code/object_attitude_calculation.zip)

The program flow chart is as below:

<img class="common_img" src="../_static/media/chapter_4/section_1/image110.png"   />
...
Launch file locates in [/home/ubuntu/jetarm/src/jetarm_example/src/5.Object_attitude_calculation/object_attitude_calculation.launch](../_static/source_code/object_attitude_calculation.zip)
...
The source code is saved in:[/homehiwonder/jetarm/src/jetarm_example/src/Simple_library/color_detection_base.py](../_static/source_code/Simple_library.zip)
...
<img class="common_img" src="../_static/media/chapter_4/section_1/image125.png"  />
...
<img class="common_img" src="../_static/media/chapter_4/section_1/image126.png"   />

Based on the schematic principles of perspective transformation, we can formulate the following equations:

<img class="common_img" src="../_static/media/chapter_4/section_1/image127.png"   />
...
<img class="common_img" src="../_static/media/chapter_4/section_1/image128.png"  />
...
<img class="common_img" src="../_static/media/chapter_4/section_1/image129.png"   />
...
<img class="common_img" src="../_static/media/chapter_4/section_1/image130.png"  />
...
<img class="common_img" src="../_static/media/chapter_4/section_1/image132.png"  />
...
[/home/hiwonder/jetarm/src/jetarm_example/src/7.Coordinate_system_transformation/coordinate_system_transformation.launch](../_static/source_code/coordinate_system_transformation.zip)
...
[/home/hiwonder/jetarm/src/jetarm_example/src/7.Coordinate_system_transformation/coordinate_system_transformation.py](../_static/source_code/coordinate_system_transformation.zip)

The program flow chart is as below:

<img class="common_img" src="../_static/media/chapter_4/section_1/image136.png"   />
...
Utilizing rospy_param to acquire distortion coefficients for CONFIG_NAME, which is the name obtained from the parameter server. The file is located at: `jetarm\src\hiwonder_imgproc\color_detection\config\config.yaml`. Specifically, `extrinsic` refers to the camera extrinsic parameters, and `white_area_pose_world` corresponds to the camera white balance parameters.
...
<img src="../_static/media/chapter_4/section_1/轨迹规划[00h00m01s-00h00m07s].gif"   />


(4) If you need to terminate the program, please use short-cut '**Ctrl+C**'. If the program fails to stop, please retry.

(5) After running the previous program, restart the app service by executing the command 'sudo systemctl start jetarm_bringup.service' and press Enter. Enter the password **'hiwonder'** to proceed. Wait until the robot arm returns to the initial pose, and the buzzer on the robot arm emits a 'beep' sound.
...
The source code is located in [/home/jetarm/src/jetarm_examplesrc/8.path_planning/path_planning.py](../_static/source_code/path_planning.zip).
...
The launch file is saved in: [/home/hiwonder/jetarm/src/jetarm_example/src/8.path_planning/path_planning.launch](../_static/source_code/path_planning.zip)
...
The source code is saved in: [/home/ubuntu/jetarm/src/jetarm_examplesrc/8.path_planning/path_planning.py](../_static/source_code/path_planning.zip)

<img class="common_img" src="../_static/media/chapter_4/section_1/image165.png"   />
...
It can be observed that the robotic arm will recognize and calculate the coordinates of the colored block, proceed to grasp the block, and the terminal will print both the pixel coordinates and the real-world coordinates of the block. By default, the system recognizes red color. If you wish to grasp other colors, refer to the following section [4.1.11 Change Default Recognizable Colors](#anchor_4_1_1), If color recognition is inaccurate, adjustments can be made by referring to [1. Getting Ready( JetArm User Manual)->1.6 Development Environment Setup and Configuration](1.Getting_Ready.md#development-environment-setup-and-configuration).

<img class="common_img" src="../_static/media/chapter_4/section_1/image184.png"  />

<p style="margin:0 auto 24px;width:100%">
<img  src="../_static/media/chapter_4/section_1/image185.png" style="width:33%" />
<img  src="../_static/media/chapter_4/section_1/image186.png" style="width:33%;" />
<img  src="../_static/media/chapter_4/section_1/image187.png" style="width:33%;" />
</p>

(4) 4)If you need to terminate the program, please use short-cut 'Ctrl+C'. If the program fails to stop, please retry. After running the previous program, you need to restart the app service by executing this command 'sudo systemctl start jetarm_bringup.service'. After you input the command, hit Enter and type the password **'hiwonder'.** Once the robot arm restores initial pose and emits a beep sound, the service is restarted successfully.
...
The source code of the launch file is saved in [/home/hiwonder/jetarm/src/jetarm_example/src/9.positioning_clamp/positioning_clamp.launch](../_static/source_code/position_clamp.zip)
...
The source code locates in [/home/hiwonder/jetarm/src/jetarm_example/src/9.positioning_clamp/positioning_clamp.py](../_static/source_code/position_clamp.zip)

<img class="common_img" src="../_static/media/chapter_4/section_1/image192.png"   />
...
The source code for this program is located at : [/home/hiwonder/jetarm/src/jetarm_6dof/jetarm_6dof_functions/scripts/color_tracking.py](../_static/source_code/jetarm_6dof.zip)
...
(1) Place the robot on the designated position on the map and calibrate the position of the robot arm according to the tutorials saved in [1. Getting Ready ( JetArm User Manual)/ 1.8 Position Adjustment for Object Gripping and Placing/Placement Position Adjustment](1.Getting_Ready.md#position-adjustment-for-object-gripping-and-placing).

(2) Start the robot arm, and access the robot system desktop using NoMachine according to the tutorials saved in [1. Getting Ready ( JetArm User Manual)->1.6 Development Environment Setup and Configuration](1.Getting_Ready.md#development-environment-setup-and-configuration).

(3) Double-click <img  src="../_static/media/chapter_4/section_1/image5.png"  /> to open the command-line terminal.Execute the command 'sudo systemctl stop jetarm_bringup.service' and hit Enter, then input the password 'hiwonder' to terminate auto-start service.
...
<img class="common_img" src="../_static/media/chapter_4/section_1/image228.png"  />

(6) If you need to terminate the program, please use short-cut '**Ctrl+C**'. If the program fails to stop, please retry.

(7) After running the previous program, you need to restart the app service by executing this command 'sudo systemctl start jetarm_bringup.service'. After you input the command, hit Enter and type the password **'hiwonder'**. Once the robot arm restores initial pose and emits a beep sound, the service is restarted successfully.
...
Once the game is initiated, place red, green, and blue blocks within the recognition area of the robot arm. When the robot arm identifies the target color block, it will grip it and place it in the corresponding location in the sorting area. If color recognition is inaccurate, refer to [1. Getting Ready (JetArm User Manual)->1.5 Color Threshold Setting](1.Getting_Ready.md#color-threshold-setting) for adjustments.

* **Launch File Analysis**

The Launch file is stored in:

[/home/hiwonder/hiwonder/jetarm/src/jetarm_6dof/jetarm_6dof_functions/launch/color_sorting.launch](../_static/source_code/jetarm_6dof.zip)
...
The source code is saved in [/home/ubuntu/jetarm/src/jetarm_6dof/jetarm_6dof_functions/scripts/color_sorting.py](../_static/source_code/jetarm_6dof.zip)

The program flowchart is as pictured.

<img class="common_img" src="../_static/media/chapter_4/section_1/image234.png"   />
...
<img class="common_img" src="../_static/media/chapter_4/section_1/image279.png"  />
...
[/home/ubuntu/jetarm/src/jetarm_example/src/9.positioning_clamp/positioning_clamp.py](../_static/source_code/position_clamp.zip)
...
[/home/hiwonder/jetarm/src/jetarm_6dof/jetarm_6dof_functions/scripts/color_tracking.py](../_static/source_code/jetarm_6dof.zip)

* **Operation Steps**

(1) Start the robot arm, and access the robot system desktop using NoMachine according to the tutorials saved in [1.Getting Ready( JetArm User Manual)->1.6 Development Environment Setup and Configuration](1.Getting_Ready.md#development-environment-setup-and-configuration).

(2) Double-click <img src="../_static/media/chapter_4/section_2/image16.png"  /> to open the command-line terminal.Execute the command 'sudo systemctl stop jetarm_bringup.service' and hit Enter to input the password **'hiwonder'** to terminate the auto-start service.
...
(6) After running the previous program, you need to restart the app service by executing this command 'sudo systemctl start jetarm_bringup.service'. After you input the command, hit Enter and type the password **'hiwonder'**. Then wait for the robot arm to return to the initial pose and the buzzer on the robot to emit a beep sound.
...
[/home/hiwonder/jetarm/src/jetarm_6dof/jetarm_6dof_functions/launch/color_tracking.launch](../_static/source_code/jetarm_6dof.zip)
...
[/home/hiwonder/jetarm/src/jetarm_6dof/jetarm_6dof_functions/scripts/tag_tracking.py](../_static/source_code/jetarm_6dof.zip)
...
[/home/ubuntu/jetarm/src/jetarm_6dof/jetarm_6dof_functions/launch/tag_tracking.launch](../_static/source_code/jetarm_6dof.zip)
...
Python source code file is saved in [/home/ubuntu/jetarm/src/jetarm_6dof/jetarm_6dof_functions/scripts/tag_tracking.py](../_static/source_code/jetarm_6dof.zip)
...
[/home/hiwonder/jetarm/src/jetarm_6dof/jetarm_6dof_functions/scripts/kcf_tracking.py](../_static/source_code/jetarm_6dof.zip)
...
(2) Double-click <img  src="../_static/media/chapter_4/section_2/image16.png"  /> to open the command-line terminal. 

(3) Execute the command 'sudo systemctl stop jetarm_bringup.service' and hit Enter to input the password 'hiwonder' to terminate the auto-start service.

```
sudo systemctl stop jetarm_bringup.service
```

(4)  Run the command 'roslaunch jetarm_6dof_functions kcf_tracking.launch' to initiate the game program.
...
[/home/hiwonder/jetarm/src/jetarm_6dof/jetarm_6dof_functions/launch/kcf_tracking.launch](../_static/source_code/jetarm_6dof.zip)
...
[/home/ubuntu/jetarm/src/jetarm_6dof/jetarm_6dof_functions/scripts/kcf_tracking.py](../_static/source_code/jetarm_6dof.zip)
