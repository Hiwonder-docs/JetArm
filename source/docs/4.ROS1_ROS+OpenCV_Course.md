...
(2) Click-on <img src="../_static/media/chapter_4/section_1/media/image5.png"  /> to open the command-line terminal, then execute the following command，Then hit Enter and type the password ‘hiwonder’ to terminate the auto-start service.
...
[/home/hiwonder/jetarm/src/jetarm_example/src/1.camera_topic_invoke/camera_topic_invoke.launch](../_static/source_code/02/camera_topic_invoke.zip)
...
[/home/hiwonder/jetarm/src/jetarm_example/src/1.camera_topic_invoke/camera_topic_invoke.py](../_static/source_code/02/camera_topic_invoke.zip)
...
② Double-click <img  src="../_static/media/chapter_4/section_1/media/image5.png"  /> to open the command-line terminal, and execute the command ‘sudo systemctl stop jetarm_bringup.service’, then hit Enter and type the password **‘hiwonder’** to terminate the app auto-start service.
...
[/home/hiwonder/jetarm/src/jetarm_example/src/Simple_library/color_detection_base.py](../_static/source_code/02/color_detection_base.zip)
...
(2) Double-click <img src="../_static/media/chapter_4/section_1/media/image5.png"  /> to open the command-line terminal, and execute the command ‘sudo systemctl stop jetarm_bringup.service’, then hit Enter and type the password **‘hiwonder’** to terminate the app auto-start service.
...
[/home/hiwonder/jetarm/src/jetarm_example/src/5.Object_attitude_calculation/object_attitude_calculation.py](../_static/source_code/02/object_attitude_calculation.zip)
...
The source code is saved in:[/homehiwonder/jetarm/src/jetarm_example/src/Simple_library/color_detection_base.py](../_static/source_code/02/color_detection_base.zip)
...
[/home/hiwonder/jetarm/src/jetarm_example/src/7.Coordinate_system_transformation/coordinate_system_transformation.launch](../_static/source_code/02/coordinate_system_transformation.zip)
...
[/home/hiwonder/jetarm/src/jetarm_example/src/7.Coordinate_system_transformation/coordinate_system_transformation.py](../_static/source_code/02/coordinate_system_transformation.zip)
...
The launch file is saved in: [/home/hiwonder/jetarm/src/jetarm_example/src/8.path_planning/path_planning.launch](../_static/source_code/02/path_planning.zip)
...
The source code of the launch file is saved in [/home/hiwonder/jetarm/src/jetarm_example/src/9.positioning_clamp/positioning_clamp.launch](../_static/source_code/02/position_clamp.zip)
...
The source code locates in [/home/hiwonder/jetarm/src/jetarm_example/src/9.positioning_clamp/positioning_clamp.py](../_static/source_code/02/position_clamp.zip)
...
The source code for this program is located at : [/home/hiwonder/jetarm/src/jetarm_6dof/jetarm_6dof_functions/scripts/color_tracking.py](../_static/source_code/02/color_tracking.zip)
...
(3) Double-click <img  src="../_static/media/chapter_4/section_1/media/image5.png"  /> to open the command-line terminal.Execute the command ‘sudo systemctl stop jetarm_bringup.service’ and hit Enter, then input the password ‘hiwonder’ to terminate auto-start service.
...
[/home/hiwonder/hiwonder/jetarm/src/jetarm_6dof/jetarm_6dof_functions/launch/color_sorting.launch](https://docs.hiwonder.com/projects/JetArm/en/latest/docs/1.Getting_Ready.html#color-threshold-setting)
...
[/home/hiwonder/jetarm/src/jetarm_6dof/jetarm_6dof_functions/scripts/color_tracking.py](../_static/source_code/02/color_tracking.zip)
...
[/home/hiwonder/jetarm/src/jetarm_6dof/jetarm_6dof_functions/launch/color_tracking.launch](../_static/source_code/02/color_tracking.launch.zip)
...
[/home/hiwonder/jetarm/src/jetarm_6dof/jetarm_6dof_functions/scripts/tag_tracking.py](../_static/source_code/02/tag_tracking.zip)
...
[/home/hiwonder/jetarm/src/jetarm_6dof/jetarm_6dof_functions/scripts/kcf_tracking.py](../_static/source_code/02/kcf_tracking.zip)
...
[/home/hiwonder/jetarm/src/jetarm_6dof/jetarm_6dof_functions/launch/kcf_tracking.launch](../_static/source_code/02/kcf_tracking.launch.zip)
