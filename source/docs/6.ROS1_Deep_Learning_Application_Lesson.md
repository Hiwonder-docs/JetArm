...
endpoint: Utilize ROS service proxy to call the `/kinematics/get_current_pose` service, retrieving the current pose information of the robot and storing it in the 'endpoint' variable.
...
```
 ...
 <img class="common_img" src="../_static/media/chapter_6/section_1/media/image55.png"  />
...
(Regarding the action group, please refer to “[2. ROS1-Robot Arm Basic Control User Manual]()”)
 ...
 <img class="common_img" src="../_static/media/chapter_6/section_1/media/Mediapipe 手势交互.gif"  />
...
The Launch file is located in:[/home/ubuntu/jetarm/src/jetarm_6dof/jetarm_6dof_functions/launch/finger_track.launch]()
...
The source code file is located in:[/home/ubuntu/jetarm/src/jetarm_6dof/jetarm_6dof_functions/scripts/finger_track.py]()
...
It can accomplish human pose recognition and execute program to display the recognition result, showing the lines connecting the human skeleton.
 ...
 <img class="common_img" src="../_static/media/chapter_6/section_1/media/image183.png"  />

### 6.8.4 Launch File Analysis 

The Launch file is located in :[/home/ubuntu/jetarm/src/jetarm_6dof/jetarm_6dof_functions/launch/mankind_pose.launch]()
...
The source code file is located in [/home/ubuntu/jetarm/src/jetarm_6dof/jetarm_6dof_functions/scripts/mankind_pose.py]()
