...
(2) Double click on  <img src="../_static/media/chapter_6/image4.png"/> to open the command line terminal.  Enter the command "**sudo systemctl stop jetarm_bringup.service**" and press Enter to disable the auto-startup service, then enter the password **"hiwonder"**.
...
Enter command "sudo systemctl start jetarm_bringup.service" and press Enter to enable app service, then enter the password **"hiwonder**". 
...
The launch file is stored in [/home/ubuntu/jetarm/src/jetarm_6dof/jetarm_6dof_functions/launch/waste_classification.launch](../_static/source_code/jetarm_6dof.zip)
...
The source code file is stored in [/home/hiwonder/src/jetarm_6dof/jetarm_6dof_functions/scripts/waste_classification.py](../_static/source_code/jetarm_6dof.zip)
...
(5) After app service is enabled successfully, the robotic arm will return to the initial posture, and the buzzer will make a "Di" sound.
...
The launch file is stored in [/home/hiwonder/jetarm/src/jetarm_6dof/jetarm_6dof_functions/launch/face_mask.launch](../_static/source_code/jetarm_6dof.zip)
...
The source code file is stored in [/home/hiwonder/src/jetarm_6dof/jetarm_6dof_functions/scripts/face_mask.py](../_static/source_code/jetarm_6dof.zip)
...
For seamless usage of MediaPipe, we suggest gaining a basic understanding of OpenCV. To delve into OpenCV, you can find detailed information in "[**4. ROS1-ROS+OpenCV Course**](4.ROS1_ROS+OpenCV_Course.md)".
...
The launch file is located in [/home/hiwonder/jetarm/src/jetarm_6dof/jetarm_6dof_functions/launch/face_mesh.launch](../_static/source_code/jetarm_6dof.zip)
...
The source code file is located in [/home/ubuntu/src/jetarm_6dof/jetarm_6dof_functions/scripts/face_mesh.py](../_static/source_code/jetarm_6dof.zip)
...
The Launch file is located in [/home/ubuntu/jetarm/src/jetarm_6dof/jetarm_6dof_functions/launch/face_tracking.launch](../_static/source_code/jetarm_6dof.zip)
...
The source code file is located in [/home/hiwonder/src/jetarm_6dof/jetarm_6dof_functions/scripts/face_tracking.py](../_static/source_code/jetarm_6dof.zip)
...
(Regarding the action group, please refer to "[**2. ROS1-Robot Arm Basic Control User Manual**](2.ROS1_Robot_Arm_Basic_Control_User_Manual.md)")

 <img class="common_img" src="../_static/media/chapter_6/2.gif"  />

### 6.6.4 Launch File Analysis 

The Launch file is located in [/home/hiwonder/src/jetarm_6dof/jetarm_6dof_functions/launch/hand_gesture.launch](../_static/source_code/jetarm_6dof.zip)
...
The source code file is located in [/home/ubuntu/jetarm/src/jetarm_6dof/jetarm_6dof_functions/scripts/hand_gesture.py](../_static/source_code/jetarm_6dof.zip)
...
The Launch file is located in:[/home/hiwonder/jetarm/src/jetarm_6dof/jetarm_6dof_functions/launch/finger_track.launch](../_static/source_code/jetarm_6dof.zip)
...
The source code file is located in: [/home/ubuntu/jetarm/src/jetarm_6dof/jetarm_6dof_functions/scripts/finger_track.py](../_static/source_code/jetarm_6dof.zip)
...
It can accomplish human pose recognition and execute program to display the recognition result, showing the lines connecting the human skeleton.
 ...
 <img src="../_static/media/chapter_14/section_1/image84.png" style="" class="common_img"/>

### 6.8.4 Launch File Analysis 

The Launch file is located in :[/home/hiwonder/jetarm/src/jetarm_6dof/jetarm_6dof_functions/launch/mankind_pose.launch](../_static/source_code/jetarm_6dof.zip)
...
The source code file is located in [/home/ubuntu/jetarm/src/jetarm_6dof/jetarm_6dof_functions/scripts/mankind_pose.py](../_static/source_code/jetarm_6dof.zip)
