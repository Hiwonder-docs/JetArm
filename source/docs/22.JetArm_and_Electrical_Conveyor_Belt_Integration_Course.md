...
<img src="../_static/media/chapter_22/section_1/media/image3.png" class="common_img" />
...
<img src="../_static/media/chapter_22/section_1/media/image4.png" class="common_img" /><img src="../_static/media/chapter_22/section_1/media/image5.png" class="common_img" />
...
<img src="../_static/media/chapter_22/section_1/media/image6.png" class="common_img" /><img src="../_static/media/chapter_22/section_1/media/image7.png" class="common_img" />
...
(2) Double-click the model configuration tool on the desktop. <img src="../_static/media/chapter_22/section_1/media/image8.png" class="common_img" />

(3) Select the appropriate options based on the robotic arm version, camera version, and accessory type:

<img src="../_static/media/chapter_22/section_1/media/image9.png" class="common_img" />
...
<img src="../_static/media/chapter_22/section_1/media/image10.png" class="common_img" />

(5) Click "Restart" to reload the configuration.

<img src="../_static/media/chapter_22/section_1/media/image11.png" class="common_img" />
...
<img src="../_static/media/chapter_22/section_1/media/image12.png" class="common_img" />
...
<img src="../_static/media/chapter_22/section_1/media/image13.png" class="common_img" />
...
<img src="../_static/media/chapter_22/section_1/media/image14.png" class="common_img" />
...
<img src="../_static/media/chapter_22/section_1/media/image15.png" class="common_img" />
...
(2) Click the terminal icon <img src="../_static/media/chapter_22/section_1/media/image16.png" class="common_img" /> in the system desktop to open a command-line window.
...
[/home/ubuntu/ros2_ws/src/motor/launch/color_sorting.launch.py](.)
...
[/home/ubuntu/ros2_ws/src/motor/motor/color_sorting.py](.)
...
Adjusts the robot’s joints to preset initial positions by sending specific servo motor position commands.
...
Used to set the motor’s rotational speed. `id`: Identifier of the motor, used to distinguish between different motors. `rps`: Target rotational speed of the motor, in revolutions per second.
...
⑮ `move` function: Used to control the motion of the robotic arm. This function determines the X-axis position of the robotic arm based on the provided `center_y` value, and then performs a series of steps to pick up and place the object.
...
⑯ Main Loop Function: Used to control the motion of the robotic arm. This function determines the X-axis position of the robotic arm based on the provided `center_y` value, and then performs a series of steps to pick up and place the object.
...
*   Once the counter exceeds 40, the system resets the counter and `start_count`, then starts a new thread to call `self.move()` with the target’s Y-coordinate to begin robotic arm movement.
...
<img src="../_static/media/chapter_22/section_1/media/image62.png" class="common_img" />
