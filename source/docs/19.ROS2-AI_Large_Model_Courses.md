...
1. After logging in to the robot remotely through NoMachine, click the desktop icon <img src="../_static/media/chapter_19\section_4/media/image1.png" style="width:70px" class="common_img" />.
...
3. When using the **AI Voice Interaction Box**, set **Microphone Type** to **wonderechopro** as shown below.
   ...
   <img src="../_static/media/chapter_19\section_4/media/image3.png" style="width:400px"  />
   ...
   <img src="../_static/media/chapter_19\section_4/media/image5.png" style="width:400px"  />
...
5. Then click **Apply & Save**.
   ...
   > [!NOTE]
   >
   > **Restart Service** is used to restart the app service. It is not related to this lesson, so there is no need to click it.
...
1) Click <img src="../_static/media/chapter_19\section_4/media/image9.png" style="width:50px" class="common_img" /> to open the command line window. Enter the command and press **Enter** to disable the auto-start service.
