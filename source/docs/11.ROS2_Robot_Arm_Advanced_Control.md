# 11. ROS2-Robot Arm Advanced Control Manual

## 11.1 Homogeneous Coordinates Transformation

### 11.1.1 Introduction to Homogeneous Coordinates 
...
### 11.1.2 Homogeneous Coordinates Function
...
### 11.2.1 Introduction to DH Modeling
...
## 11.3 Forward Kinematics Analysis

### 11.3.1 Introduction to Inverse Kinematics
...
### 11.3.2 JetArm Forward Kinematics Analysis
...
### 11.3.3 Introduction to Forward Kinematics Service
...
(1) Click-on <img src="../_static/media/chapter_11/section_1/image1.png" style="width:0.5625in;height:0.48958in" /> to open the command-line terminal, and execute the command below to disable the app auto-start service.
...
<img src="../_static/media/chapter_11/section_1/image41.png" class="common_img"/>
...
### 11.3.4 Servo Control Topic

* **Invoke Service**

(1) Open a new terminal <img src="../_static/media/chapter_11/section_1/image2.png" style="width:0.5625in;height:0.48958in" />, and execute the command below.
...
<img src="../_static/media/chapter_11/section_1/image44.png" class="common_img"/>
...
The source code is stored in [/home/ubuntu/ros2_ws/src/example/example/simple/include/fk.py](../_static/source_code/simple.zip)

The program's logical flowchart is illustrated in the diagram below.

<img src="../_static/media/chapter_11/section_1/image48.png" class="common_img"/>
...
## 11.4 Inverse Kinematics Analysis
...
### 11.4.3 JetArm Inverse Kinematics Analysis
...
### 11.4.4 Introduction to Inverse Kinematics Service
...
(1) Click-on <img src="../_static/media/chapter_11/section_1/image1.png" style="width:0.5625in;height:0.48958in" /> to open the command-line terminal. Execute the command below to disable the auto-start service.
...
<img src="../_static/media/chapter_11/section_1/image65.png" class="common_img"/>
...
<img src="../_static/media/chapter_11/section_1/1.gif"/>

### 11.4.5 Servo Control Topic
...
<img src="../_static/media/chapter_11/section_1/image67.png" class="common_img"/>
...
<img src="../_static/media/chapter_11/section_1/image69.png" class="common_img"/>
...
The source code is saved in [/home/ubuntu/ros2_ws/src/example/example/simple/include/ik.py](../_static/source_code/simple.zip)

The program's logical flowchart is illustrated in the diagram below.

<img src="../_static/media/chapter_11/section_1/image71.png" class="common_img"/>
