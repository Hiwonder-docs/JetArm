# 10.  ROS2-Robot Arm Basic Control User Manual 

## 10.1 Servo Control Node
...
<img src="../_static/media/chapter_10/image5.png"/>

### 10.1.1 Introduction to Servo Control Node

* **Preparation**

(1) Assemble the robot arm according to the tutorial stored in [1. Getting Ready->1. 2 Hardware Installation and Guidelines](1.Getting_Ready.md#hardware-installation-and-guidelines)

(2) Start the robot arm according to the tutorial saved in [1. Getting Ready->1.3 Initial Startup Instructions](1.Getting_Ready.md#initial-startup-instructions)

(3) Access the robot arm system desktop according to the tutorials locating in [1. Getting Ready->1.6 Development Environment Setup and Configuration](1.Getting_Ready.md#development-environment-setup-and-configuration)

* **Initiate Servo Control Node**

(1) Click on <img src="../_static/media/chapter_10/image1.png" /> to open the terminal, then execute the following command to disable the auto-start service.
...
(3) Open a new terminal <img src="../_static/media/chapter_10/image2.png" style="width:0.5625in;height:0.48958in" /> and run the command to display the topics published after the initiation of the robot arm node.

```bash
ros2 topic list
```

<img src="../_static/media/chapter_10/image10.png" class="common_img" />

* **Program outcome**

<img class="common_img" src="../_static/media/chapter_2/gif1.gif" />

### 10.1.2 Servo Control Through Topic
...
<img src="../_static/media/chapter_10/image12.png" />



### 10.1.3 Initiate App Auto-Start Service
...
<img src="../_static/media/chapter_10/image15.png" class="common_img"/>
...
The launch file locates in this folder, [/home/ubuntu/ros2_ws/src/example/example/simple/bus_servo.launch.py](../_static/source_code/simple.zip)
...
The source code of the program is saved in [/home/ubuntu/ros2_ws/src/example/example/simple/include/bus_servo_node.py](../_static/source_code/simple.zip)

The program logic flowchart is as below:

<img src="../_static/media/chapter_10/image20.png" class="common_img"/>
...
### 10.2.1 Introduction to LED Control Node
...
(1) Click on <img src="../_static/media/chapter_10/image1.png" style="width:0.5625in;height:0.48958in" /> to open the terminal, then execute the command to disable the auto-start service.
...
<img src="../_static/media/chapter_10/image24.png" class="common_img"/>

|      **Topic**      |         **Function**          |
|:-------------------:|:-----------------------------:|
| /jetarm_sdk/set_led | Control LED to turn on or off |

### 10.2.2 Control LED Through Topic
...
<img src="../_static/media/chapter_10/image26.png" />
...
Launch file is saved in [/home/ubuntu/ros2_ws/src/example/example/simple/led.launch.py](../_static/source_code/simple.zip)
...
The source code is stored in [/home/ubuntu/ros2_ws/src/example/example/simple/include/led_node.py](../_static/source_code/simple.zip)

The program logic flowchart is as below:

<img src="../_static/media/chapter_10/image35.png" class="common_img"/>
...
## 10.3 Buzzer Control Node

### 10.3.1 Introduction to Buzzer Node
...
(1) Click on <img src="../_static/media/chapter_10/image1.png" /> to open the terminal, then execute the command to disable the app auto-start service.
...
<img src="../_static/media/chapter_10/image43.png" class="common_img"/>

|            **Topic**             |           **Function**           |
|:--------------------------------:|:--------------------------------:|
| /ros_robot_controller/set_buzzer | Control buzzer to turn on or off |

### 10.3.2 Buzzer Control Through Topic
...
<img src="../_static/media/chapter_10/image45.png"  class="common_img"/>
...
<img src="../_static/media/chapter_10/image46.png" class="common_img"/>
...
### 10.3.3 Initiate App Auto-Start Service
...
[/home/ubuntu/ros2_ws/src/example/example/simple/buzzer.launch.py](../_static/source_code/simple.zip)
...
The source code is saved in [/home/ubuntu/ros2_ws/src/example/example/simple/include/buzzer_node.py](../_static/source_code/simple.zip)

The program logic flowchart is depicted as below:

<img src="../_static/media/chapter_10/image50.png" class="common_img"/>
...
```
 ...
 `time`: Used to configure delays.

 `rclpy`:The ROS2 Python client library that provides functionality for creating and managing ROS2 nodes and communication.

 `Node`: A base class used for creating ROS2 nodes.

 `Trigger`: A standard service type in ROS2, typically used for sending simple requests and responses without parameters or return values.

 `BuzzerState`: A custom message type designed to configure the state of the buzzer.
...
② Create a topic publisher and wait for the robotic arm's underlying control service to start.
...
## 10.4 PC Software Control

### 10.4.1 Introduction to PC Software Function
...
### 10.4.3 Integrate Action Groups
...
<img class="common_img" src="../_static/media/chapter_10/image3.png" />
...
(1) Start the robot arm according to the instructions provided in [1. Getting Ready(JetArm User Manual)->1.3 Initial Startup Instructions](1.Getting_Ready.md#initial-startup-instructions) .

(2) Access the robot system desktop according to the tutorials provided in this folder [1. Getting Ready(JetArm User Manual)->1.6 Development Environment Setup and Configuration](1.Getting_Ready.md#development-environment-setup-and-configuration).
...
The servo is now centered, so please refrain from forcibly manipulating the servo shaft. If the servo horn 'cross' is not correctly installed, repeat steps 5-7 in [Large Deviation Adjustment](#anchor_11_4_4_4) of this document.
...
## 10.5 Use of Servo Debugging Tool
...
### 10.5.1 Introduction to Servo Debugging Tool Interface

(1) Access the robot system desktop according to the tutorials provided in [1. Getting Ready(JetArm User Manual) ->1.6 Development Environment Setup and Configuration](1.Getting_Ready.md#development-environment-setup-and-configuration).
...
### 10.5.2 Servo Debugging Instructions

(1) Connect one servo to the servo port.

<img class="common_img" src="../_static/media/chapter_2/image151.png" />

(2) Enter the following command to launch the servo debugging tool. Ensure that only one servo is connected to the serial bus servo port during this process.

```
python3 factory_utils/Bus_Servo_Tool/main.py
```
...
(6) After setting the servo ID, detach and assemble the servos according to the [Large Deviation Adjustment](#anchor_11_4_4_4).