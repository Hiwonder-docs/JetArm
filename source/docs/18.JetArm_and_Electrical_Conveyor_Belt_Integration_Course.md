# 18. JetArm + Conveyor Belt Course

## 18.1 Conveyor Belt Installation

(1) Remove the plastic part near the motor end.

<img src="../_static/media/chapter_18/image3.png" class="common_img" style="width:700px;"/>
...
<img src="../_static/media/chapter_18/image4.png" class="common_img" style="width:700px;"/>

<img src="../_static/media/chapter_18/image5.png" class="common_img" style="width:700px;"/>
...
<img src="../_static/media/chapter_18/image6.png" class="common_img" />

<img src="../_static/media/chapter_18/image7.png" class="common_img" style="width:700px;"/>

## 18.2 Selecting the Robot Type
...
<img src="../_static/media/chapter_18/image8.png" class="common_img" />

(3) Select the appropriate options based on the robotic arm version, camera version, and accessory type:

<img src="../_static/media/chapter_18/image9.png" class="common_img" />
...
<img src="../_static/media/chapter_18/image12.png" class="common_img" />
...
<img src="../_static/media/chapter_18/image13.png" class="common_img" />

### 18.3.3 Control Modes
...
<img src="../_static/media/chapter_18/image14.png" class="common_img" />
...
<img src="../_static/media/chapter_18/image15.png" class="common_img" />
...
### 18.3.4 Operation Steps

(1) Start the robotic arm and access the robot system using the NoMachine.

(2) Double click<img src="../_static/media/chapter_18/image16.png"/>to launch the command terminal.
...
(4) Open a new terminal<img src="../_static/media/chapter_18/image17.png"/>and enter the following command to initiate the underlying SDK.

```
ros2 launch sdk jetarm_sdk.launch.py 
```

(5) Open a new terminal <img src="../_static/media/chapter_18/image17.png"/>and run the following command to initiate the controller control service.
...
### 18.4.2 Enabling the Feature

(1) Power on the robotic arm and connect it to the remote control software NoMachine. For installation and connection of the remote desktop tool, see [1.6 Development Environment Setup and Configuration](1.Getting_Ready.md#development-environment-setup-and-configuration).

(2) Click the terminal icon <img src="../_static/media/chapter_18/image16.png"/> in the system desktop to open a command-line window.
...
(4) Open a new terminal <img src="../_static/media/chapter_18/image17.png"/>,and enter the following command to start the feature.
...
### 18.4.5 Python Source Code Analysis
...
(5) Initializing Controllers and Publishers
...
(10) set_motor Function: 

Used to set the motor's rotational speed.
...
Used to send asynchronous requests to ROS2 services and wait for their responses. This function simplifies interaction with ROS2 services, making service calls more intuitive and efficient.
...
(12) Sending Asynchronous Requests
...
-  adaptive_threshold Function: Used to apply adaptive thresholding on a grayscale image. Adaptive thresholding is an image processing technique that effectively binarizes an image under uneven lighting conditions, improving the separation of foreground and background.
...
(13) canny_proc Function

Mainly used to perform edge detection on the input color image in BGR format for subsequent image segmentation.
...
(14) get_top_surface Function

Mainly used to process the input RGB image to extract the top surface of the object. It applies a series of image processing techniques such as color space conversion, filtering, thresholding, and edge detection to generate a mask image containing only the target region.
...
⑥ self.adaptive_threshold is a custom method using Gaussian weighting to calculate the threshold, providing stronger adaptability.
...
This function processes the image messages received from the camera topic and stores the processed images in a queue for further use.
...
(16) image_processing Function

This function retrieves one RGB image frame from the image queue, performs color segmentation and contour detection, identifies red, green, and blue targets in the image, and annotates the detected target positions, indices, and angle information on the resulting image.
...
(18) move Function: Used to control the motion of the robotic arm. This function determines the X-axis position of the robotic arm based on the provided `center_y` value, and then performs a series of steps to pick up and place the object.
...
(19) main Function: Main Loop Function used to control the motion of the robotic arm. This function determines the X-axis position of the robotic arm based on the provided `center_y` value, and then performs a series of steps to pick up and place the object.
...
(20) Main Function: Program Entry Point
...
### 18.4.6 Adjusting the Gripping Offset
...
<img src="../_static/media/chapter_18/image62.png" class="common_img" />
