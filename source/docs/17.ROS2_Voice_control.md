# 17. ROS2-Voice Control Course

## 17.1 Microphone Array Installation

(1) Fix the 6-Microphone array to the JetArm using four M4\*6 screws.

<img class="common_img" src="../_static/media/chapter_17/section_1/image2.png" style="width:5.74167in;height:4.63403in"  />

(2) The image below shows the assembled configuration of the 6-microphone array.

<img class="common_img" src="../_static/media/chapter_17/section_1/image3.png" style="width:5.75in;height:5.75in"  />

(3) Connect the 6-CH microphone array to USB Port 2 on the controller, as shown below.

<img class="common_img" src="../_static/media/chapter_17/section_1/image4.png" style="" />

<p id="anchor_17_2"></p>

## 17.2 Switching Between Chinese and English Wake Words
...
To change the recognition language, open the configuration tool by double-clicking the "**Tool**" icon on the desktop <img src="../_static/media/chapter_17/section_2/image2.png" style="width:0.61597in;height:0.47361in" />. 
...
<img class="common_img" src="../_static/media/chapter_17/section_2/image4.png" style="width:500px;"  />

<img class="common_img" src="../_static/media/chapter_17/section_2/image5.png" style="width:500px;" />

(3) Click "**Apply & Save**" to confirm and save your settings.

<img class="common_img" src="../_static/media/chapter_17/section_2/image6.png" style="width:500px;" />

## 17.3 Voice Control Basic Lesson
...
### 17.3.1 R818 Noise Reduction Board
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image2.png" style="width:700px;"  />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image3.png" style="width:700px;"  />

Back view:

<img class="common_img" src="../_static/media/chapter_17/section_3/image4.png"  style="width:700px;" />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image5.png" style="width:320px;"  /> 

<img class="common_img" src="../_static/media/chapter_17/section_3/image6.png"  style="width:350px;" />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image7.png"  style="width:350px;" />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image8.png"  style="width:600px;" />

Back view:

<img class="common_img" src="../_static/media/chapter_17/section_3/image18.png" style="width:600px;"  />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image10.png" style="width:700px;"  />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image11.png"  style="width:350px;" />

<img class="common_img" src="../_static/media/chapter_17/section_3/image12.png"  style="width:350px;" />

<img class="common_img" src="../_static/media/chapter_17/section_3/image13.png" style="width:350px;"  />

<img class="common_img" src="../_static/media/chapter_17/section_3/image14.png"  />

(3) Connect the two UAC-to-USB cables to the noise deduction board as below:

<img class="common_img" src="../_static/media/chapter_17/section_3/image15.png"  style="width:500px;" />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image16.png" style="width:500px;"  />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image17.png"  style="width:500px;" />

Tighten the four screws:

<img class="common_img" src="../_static/media/chapter_17/section_3/image18.png"  style="width:500px;" />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image118.png"   />

<img class="common_img" src="../_static/media/chapter_17/section_3/image20.png"   />

<p id="anchor_17_3_3"></p>

###  17.3.3 Virtual Machine Installation and Configuration
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image21.png"  />

(3) Follow the images below to complete the virtual machine installation.

<img class="common_img" src="../_static/media/chapter_17/section_3/image22.png"  />

<img class="common_img" src="../_static/media/chapter_17/section_3/image23.png"  />

<img class="common_img" src="../_static/media/chapter_17/section_3/image24.png"  />

<img class="common_img" src="../_static/media/chapter_17/section_3/image25.png"  />

<img class="common_img" src="../_static/media/chapter_17/section_3/image26.png"  />

<img class="common_img" src="../_static/media/chapter_17/section_3/image27.png"  />

<img class="common_img" src="../_static/media/chapter_17/section_3/image28.png"  />

* **Import Virtual Machine**

After entering the virtual machine interface, click on "**Open Virtual Machine**".

<img class="common_img" src="../_static/media/chapter_17/section_3/image218.png"  />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image33.png" style="width:440px;" />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image36.png"  />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image318.png"  />

* **Start Virtual Machine**

(1) Click-on `Power on this virtual machine`.

<img class="common_img" src="../_static/media/chapter_17/section_3/image40.png"  />

(2) After start-up, you will enter the desktop of the virtual machine.

<img class="common_img" src="../_static/media/chapter_17/section_3/image41.png"  />

* **Install Dependency**

(1) Click-on <img src="../_static/media/chapter_17/section_3/image42.png"  /> to start the command-line, the execute the following command to install pip:
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image44.png"  />
...
### 17.3.4 6-Channel Microphone Array Configuration

* **Create Workspace**

(1) Click-on <img src="../_static/media/chapter_17/section_3/image42.png"  /> to open the command-line terminal, and run the following command to create a folder.
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image47.png"  />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image50.png"  />

(2) Drag the files from the same directory into the virtual machine folder.

<img class="common_img" src="../_static/media/chapter_17/section_3/image51.png"  />

<img class="common_img" src="../_static/media/chapter_17/section_3/image52.png"  />

(3) Extract the two files into the current directory.

<img class="common_img" src="../_static/media/chapter_17/section_3/image53.png"  />

(4) Enter the extracted folder and move the three folders to `/ros2_ws/src`.

<img class="common_img" src="../_static/media/chapter_17/section_3/image54.png"  />

(5) Delete unnecessary files inside `/ros2_ws/src`.

<img class="common_img" src="../_static/media/chapter_17/section_3/image55.png"  />

(6) Exit the `src` folder and return to the `ros_ws` folder, then open the command line.

<img class="common_img" src="../_static/media/chapter_17/section_3/image56.png"  />

<img class="common_img" src="../_static/media/chapter_17/section_3/image57.png"  />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image518.png"  />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image63.png"   />

(2) Choose `Sign up with phone number`, and fill in the required information. (select corresponding country code)

<img class="common_img" src="../_static/media/chapter_17/section_3/image64.png"   />

(3) After registration, click `console->my application` to add new application.

<img class="common_img" src="../_static/media/chapter_17/section_3/image65.png"   />

(4) Fill in the required information, and click `Submit`.

<img class="common_img" src="../_static/media/chapter_17/section_3/image66.png"   />

(5) Open the application you just added.

<img class="common_img" src="../_static/media/chapter_17/section_3/image67.png"  />

(6) Click `Voice recognition->Offline voice command recognition (Latest version)`

<img class="common_img" src="../_static/media/chapter_17/section_3/image68.png"   />

(7) Download Linux AIKit.

<img class="common_img" src="../_static/media/chapter_17/section_3/image618.png"   />

<img class="common_img" src="../_static/media/chapter_17/section_3/image70.png"   />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image71.png"   />

(9) Choose`OK` to start downloading.

<img class="common_img" src="../_static/media/chapter_17/section_3/image72.png"   />

* **Replace Offline Voice Resources and ID**

(1) Unzip the file below and locate the offline voice resource `common.jet`.

<img class="common_img" src="../_static/media/chapter_17/section_3/image73.png"  style="width:690px;" />

(2) Click the icon below.

<img class="common_img" src="../_static/media/chapter_17/section_3/image74.png"  />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image75.png"  />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image76.png" style="width:100%;" />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image77.png"  />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image78.png"  />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image76.png"  />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image81.png"  />

(3) Modify the parameter highlighted in the red box below to change the wake-up word.

<img class="common_img" src="../_static/media/chapter_17/section_3/image82.png"  />

English wakeup word format: word1 word2 word3

(1) To change the wakeup language, you can directly change the below parameter.

<img class="common_img" src="../_static/media/chapter_17/section_3/image83.png"  />
...
### 17.3.5 Set Wake-Up Command

(1) Connect the microphone array to the computer according to section **[17.3.2 Wiring](#anchor_17_3_2)**.

<img class="common_img" src="../_static/media/chapter_17/section_3/image118.png"   />

(2) Connect the device to the virtual machine.

<img class="common_img" src="../_static/media/chapter_17/section_3/image86.png"  />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image88.png"  />

(5) If you want to close this node, use short-cut `'Ctrl+C'`.

### 17.3.6 Sound Source Localization and Speech Recognition
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image90.png"  />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image91.png"  />

(2) Voice Recognition

After activating the microphone, speak the specific command to be recognized.

<img class="common_img" src="../_static/media/chapter_17/section_3/image92.png"  />

Command location: `ros2_ws/src/xf_mic_asr_offline/config/call.bnf`

<img class="common_img" src="../_static/media/chapter_17/section_3/image93.png"  />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image94.png"  />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image95.png"  />

<img class="common_img" src="../_static/media/chapter_17/section_3/image96.png"  style="width:690px;" />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image97.png"  />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image918.png"  style="width:300px;" />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image100.png" style="width:350px;"  />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image101.png" style="width:700px;"  />

<img class="common_img" src="../_static/media/chapter_17/section_3/image102.png" style="width:700px;"  />

(2) Then connect the USB extension cable to sound card.

<img class="common_img" src="../_static/media/chapter_17/section_3/image103.png"  style="width:700px;" />

<img class="common_img" src="../_static/media/chapter_17/section_3/image103.1.png"/>
...
(1) Start the virtual machine. Regarding the configuration and installation method of the virtual machine, please refer to the section "**[17.1.3 Virtual Machine Installation and Configuration](#anchor_17_3_3)**"

(2) Connect sound card and speaker to any USB interface on computer according to the instruction in "**[17.3.2 Wiring](#anchor_17_3_2)**".
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image104.png" style="width:400px;" />

(3) Open settings.

<img class="common_img" src="../_static/media/chapter_17/section_3/image105.png" style="width:400px;" />

(4) Click `"Sound\>Output device\>Test"`.

<img class="common_img" src="../_static/media/chapter_17/section_3/image106.png"  />

(5) Once opened, users should connect the wires to the SPK- and SPK+ ports correctly. Since the speaker is mono, you can test it by selecting `Front Right.` For detailed information on wiring connections, please refer to "**[17.3.2 Wiring](#anchor_17_3_2)**"

<img class="common_img" src="../_static/media/chapter_17/section_3/image107.png"  />
...
<img class="common_img" src="../_static/media/chapter_17/section_3/image108.png"  />

(2) Next, switch back to the virtual machine and click on the file manager <img src="../_static/media/chapter_17/section_3/image1018.png"  /> located on the left side of the screen. Select the **test_sound** file by left-clicking on it, then drag it into the file manager. This will save it in the home directory of the user group.

<img class="common_img" src="../_static/media/chapter_17/section_3/image110.png"  />
...
## 17.4 Voice Control Application
...
(1) Use `NoMachine` to remotely log in to the device, then click the microphone configuration icon located on the desktop <img src="../_static/media/chapter_17/section_4/image5.png" style="width:0.61597in;height:0.47361in" />。

(2) Select the correct microphone version based on your hardware.

<img src="../_static/media/chapter_17/section_4/image6.png" class="common_img" />

For devices using a `six-microphone array`, select `xf` as the microphone type (as shown in the image below).

<img src="../_static/media/chapter_17/section_4/image7.png" class="common_img"/>

<img src="../_static/media/chapter_17/section_4/image8.png" class="common_img" />

(3) Click "**Apply & Save**", then click "**Restart Service**" to complete the setup.

<img src="../_static/media/chapter_17/section_4/image9.png" class="common_img"/>
...
<img src="../_static/media/chapter_17/section_4/image10.png" class="common_img"/>
...
<img src="../_static/media/chapter_17/section_4/image12.png" class="common_img" />

<img src="../_static/media/chapter_17/section_4/image13.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_4/image14.png" class="common_img" />

④ Move the `common.jet` file from the desktop into the above directory.

<img src="../_static/media/chapter_17/section_4/image15.png" class="common_img"/>
...
<img src="../_static/media/chapter_17/section_4/image16.png" class="common_img"/>
...
<img src="../_static/media/chapter_17/section_4/image17.png" class="common_img"/>

### 17.4.2 Voice-Controlled Color Sorting
...
(2) Please calibrate the position of the robot arm before starting the voice-controlled color sorting function. To get detailed instruction, please refer to [1.Getting Ready(JetArm User Manual)-> 1.4.5 Position Calibration](1.Getting_Ready.md#position-calibration).
...
* In case of an incorrect recognition result, follow the instructions provided in [1. Getting Ready( JetArm User Manual)->1.5 Color Threshold Setting](1.Getting_Ready.md#color-threshold-setting) to adjust the color threshold for a more accurate outcome.
...
If you wish to use a wake word in a different language, please refer to the guide titled ["**17.2 Switching Between Chinese and English Wake Words**"](#anchor_17_2) 

(3) Double-click <img src="../_static/media/chapter_17/section_4/image18.png" style="width:0.48889in;height:0.53403in" /> to open the command-line terminal.
...
(6) Open a new terminal, and run this command.
...
<img src="../_static/media/chapter_17/section_4/image21.png" class="common_img"/>

Press `Ctrl+C` to exit after activating the wake-up word.

(7) Execute the following command to run the game.

```
ros2 launch xf_mic_asr_offline voice_control_color_sorting.launch.py
```

(8) Speak the wake-up word (default is "**Hello Hiwonder**"), then subsequently issue the command to initiate color sorting.

(9) To exit this mode, press Ctrl+C in the terminal. If the process does not terminate successfully, please try again multiple times.

(10) Following the above function, it is essential to enable the app service; otherwise, the app functions may be impacted.

```
sudo systemctl start start_app_node.service
```

(11) After the service is initiated successfully, the robot will emit a beeping sound.
...
[/home/ubuntu/ros2_ws/src/xf_mic_asr_offline/launch/voice_control_color_sorting.launch.py](../_static/source_code/ROS2_xf_mic_asr_offline.zip)
...
[/home/ubuntu/ros2_ws/src/xf_mic_asr_offline/scripts/voice_control_color_sorting.py](../_static/source_code/ROS2_xf_mic_asr_offline.zip)

The program flowchart is as below:

<img src="../_static/media/chapter_17/section_4/image27.png" class="common_img"/>
...
### 17.4.3 Voice Controlled Color Tracking
...
For learning about the PID algorithm, refer to "[**12. ROS2- OpenCV Vision Course->12.2 Target Tracking**](12.ROS2_OpenCV_Vision_Course.md#target-tracking)"
...
* If there is an incorrect recognition result, refer to the instructions in [1. Getting Ready(JetArm User Manual)->1.5 Color Threshold Setting](1.Getting_Ready.md#color-threshold-setting) to adjust the color threshold for a more precise outcome.

:::

(1) Start the robot, and access the remote desktop using NoMachine. For detailed instruction, please refer to the file saved in [1. Getting Ready(JetArm User Manual)->1.5 Color Threshold Setting](1.Getting_Ready.md#color-threshold-setting).
...
(9) After the service is initiated successfully, the robot arm will recover the initial pose, and the buzzer will emit a beeping sound.
...
[/home/ubuntu/ros2_ws/src/xf_mic_asr_offline/launch/voice_control_color_track.launch.py](../_static/source_code/ROS2_xf_mic_asr_offline.zip)
...
[/home/jetarm/src/xf_mic_asr_offline/scripts/voice_control_color_sortting.py](../_static/source_code/ROS2_xf_mic_asr_offline.zip)

The program flowchart is as below:

<img src="../_static/media/chapter_17/section_4/image37.png" class="common_img"/>
