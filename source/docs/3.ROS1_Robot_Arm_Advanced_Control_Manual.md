...
<img src="../_static/media/chapter_3/section_1/media/gif1.gif"/>
...
The source code is stored in [/home/hiwonder/jetarm/src/jetarm_example/src/kinematics_demo/fk.py](../_static/source_code/02/fk.zip)
...
(1) Click-on <img src="../_static/media/chapter_3/section_1/media/image39.png"  /> to open the command-line terminal. Execute the command below and hit Enter. Then type the password, **hiwonder**.
...
(3) Open a new command-line terminal <img  src="../_static/media/chapter_3/section_1/media/image39.png"  />, and run the command below to  launch the robot arm kinematics service.
...
<img class="common_img" src="../_static/media/chapter_3/section_1/media/image75.png"  />
...
<img src="../_static/media/chapter_3/section_1/media/gif2.gif"  />

* **Program Analysis**

The source code is saved in [/home/hiwonder/jetarm/src/jetarm_example/src/kinematics_demo/ik.py](../_static/source_code/02/ik.zip)
